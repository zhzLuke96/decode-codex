...
import { i as S, n as C, o as w, r as T } from "./chunk-AGHRB4JF-BnZGsowC.js";
import {
  B as E,
  C as D,
  V as O,
...
import { i as ie, n as ae, r as oe, t as se } from "./src-Nh9FV0Z1.js";
import { t as ce } from "./dist-D7478mrP.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-UvSvAGiR.js";
var de = n((e, t) => {
    (function (n, r) {
        ...
        draw: C(function (e, t, n, l) {
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (u.barHeight + u.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (u.barHeight + u.barGap);
          ...
          let O = g.select(`[id="${t}"]`),
            k = p()
              ...
              .rangeRound([0, $ - u.leftPadding - u.rightPadding]);
          function A(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
            ...
            if (
              (d
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (u.barHeight + u.barGap) + u.barHeight * 2
                    : a;
                })
          ...
          function re(e, t, n, r, i, a, o, s) {
            ...
            for (let { startTime: e, endTime: t } of a)
              ((c === void 0 || e < c) && (c = e),
                (d === void 0 || t > d) && (d = t));
            if (!c || !d) return;
            if ((0, P.default)(d).diff((0, P.default)(c), `year`) > 5) {
              S.warn(
                `The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.`,
              );
              return;
            }
            let f = l.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(c);
            for (; h.valueOf() <= d; )
              (l.db.isInvalidDate(h, f, o, s)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`height`, i - t - u.gridLineStartPadding)
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-BHZaZOiI.js.map
