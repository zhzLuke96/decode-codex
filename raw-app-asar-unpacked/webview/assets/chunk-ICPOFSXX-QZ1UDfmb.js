...
import {
  ...
  r as ee,
  t as te,
} from "./chunk-AGHRB4JF-Dyb8Hiwf.js";
function p(e) {
  return function (t) {
...
`,
      ...
      (tn = f(async (e, n) => {
        if (!$t(e)) return e;
        if (!(Zt() || n.legacyMathML || n.forceLegacyMathML))
          return e.replace(Qt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await t(
            ...
            i =
              n.forceLegacyMathML || (!Zt() && n.legacyMathML)
                ? `htmlAndMathml`
                : `mathml`;
          return e
            .split(Pt)
...
//# sourceMappingURL=chunk-ICPOFSXX-QZ1UDfmb.js.map
