...
import { i as e, o as t, r as n, t as r } from "./src-N8Nx3BNC.js";
import { t as i } from "./init-DU5j7PcD.js";
import { h as a } from "./chunk-5PVQY5BW-cQSx0740.js";
import {
  B as o,
  F as s,
  G as c,
...
import { t as ne } from "./dist-CzYIBkfN.js";
...
function qe(e, t, n, r, i, a) {
  ...
  function l(t, n, r) {
    let i = Math.abs(n - t) / r,
      a = g(([, , e]) => e).right(s, i);
    if (a === s.length) return e.every(o(t / Te, n / Te, r));
    if (a === 0) return Se.every(Math.max(o(t, n, r), 1));
    let [c, l] = s[i / s[a - 1][2] < s[a][2] / i ? a - 1 : a];
    return c.every(l);
  }
  return [c, l];
}
...
function Cn(e, t, n, r, i, a, o, c, u, d) {
  var p = s(),
    m = p.invert,
    h = p.domain,
    g = d(`.%L`),
  ...
  return (
    ...
    (p.copy = function () {
      return l(p, Cn(e, t, n, r, i, a, o, c, u, d));
    }),
    p
  );
}
      ...
      draw: n(function (t, i, a, o) {
        ...
        if (
          ...
          for (let n of Object.keys(e)) {
            let r = di(e[n], t) + 1;
            ((t += r), (v += r * (s.barHeight + s.barGap)), (_[n] = r));
          }
        } else {
          v += m.length * (s.barHeight + s.barGap);
          for (let e of g) _[e] = m.filter((t) => t.type === e).length;
        }
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-BJXWyM-p.js.map
