...
function ys(e, t, n) {
  ...
  return (Ts(e, r), Es(e, t, r, n, ...s(n.definition, (n) => ms(e, t, n))));
}
function bs(e, t, n) {
  let r = G(e, t, n, { type: 1 });
...
var Bs = class extends Co {
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (Vs(f, !1) && !o) {
      ...
      return function (e) {
        ...
        let r = Us.call(this, c, d, t, l);
        return typeof r == `number` ? r : void 0;
      };
    else
      return function () {
        let e = Us.call(this, c, d, zs, l);
  ...
  buildLookaheadForOptional(e) {
    let {
      ...
      p = s(ba({ maxLookahead: 1, occurrence: t, prodType: a, rule: i }), (e) =>
        s(e, (e) => e[0]),
      );
    if (Vs(p) && p[0][0] && !c) {
      let e = p[0],
...
function qs(e) {
  let t = s(e.prefixPath, (e) => Ui(e)).join(`, `),
...
//# sourceMappingURL=chunk-K5T4RW27-D2vW2yFf.js.map
