var e = class e extends Error {
    constructor(t, n) {
      ...
      (super(r),
        ...
        (this.position = i),
        i != null && a != null && (this.length = a - i),
        (this.rawMessage = t));
    }
  },
  t = /([A-Z])/g,
  n = (e) => e.replace(t, `-$1`).toLowerCase(),
  r = { "&": `&amp;`, ">": `&gt;`, "<": `&lt;`, '"': `&quot;`, "'": `&#x27;` },
  i = /[&><"']/g,
  a = (e) => String(e).replace(i, (e) => r[e]),
  o = (e) =>
    e.type === `ordgroup` || e.type === `color`
      ? e.body.length === 1
        ? o(e.body[0])
        : e
      : e.type === `font`
        ? o(e.body)
        : e,
  s = new Set([`mathord`, `textord`, `atom`]),
  c = (e) => s.has(o(e).type),
  l = (e) => {
...
var f = class {
    constructor(e) {
      ...
      for (var t of Object.keys(u)) {
        var n = u[t],
          r = e[t];
        this[t] = r === void 0 ? d(n) : n.processor ? n.processor(r) : r;
      }
    }
    reportNonstrict(t, n, r) {
      var i = this.strict;
      if (
        (typeof i == `function` && (i = i(t, n, r)), !(!i || i === `ignore`))
      ) {
        if (i === !0 || i === `error`)
          throw new e(
  ...
  ne = [h, h, _, _, y, y, x, x],
  re = [m, h, g, _, g, _, g, _],
  T = { DISPLAY: S[m], TEXT: S[g], SCRIPT: S[v], SCRIPTSCRIPT: S[b] },
  ie = [
    {
      name: `latin`,
      blocks: [
...
function ae(e) {
  for (var t = 0; t < ie.length; t++)
    for (var n = ie[t], r = 0; r < n.blocks.length; r++) {
      var i = n.blocks[r];
...
var oe = [];
ie.forEach((e) => e.blocks.forEach((e) => oe.push(...e)));
function se(e) {
  for (var t = 0; t < oe.length; t += 2)
    if (e >= oe[t] && e <= oe[t + 1]) return !0;
  return !1;
}
var E = (e) => e + ` ` + e,
  ce = 80,
...
219 661 l218 661zM702 ` +
  ...
  _e = function (e, t) {
    switch (e) {
      case `⎜`:
        return E(`M291 0 H417 V` + t + ` H291z`);
      case `∣`:
        return E(`M145 0 H188 V` + t + ` H145z`);
      case `∥`:
        return (
          E(`M145 0 H188 V` + t + ` H145z`) + E(`M367 0 H410 V` + t + ` H367z`)
        );
      case `⎟`:
        return E(`M457 0 H583 V` + t + ` H457z`);
      case `⎢`:
        return E(`M319 0 H403 V` + t + ` H319z`);
      case `⎥`:
        return E(`M263 0 H347 V` + t + ` H263z`);
      case `⎪`:
        return E(`M384 0 H504 V` + t + ` H384z`);
      case `⏐`:
        return E(`M312 0 H355 V` + t + ` H312z`);
      case `‖`:
        return (
          E(`M257 0 H300 V` + t + ` H257z`) + E(`M478 0 H521 V` + t + ` H478z`)
        );
      default:
        return ``;
    }
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`
  ...
  Ce = function (e) {
    return (
      ...
      e in xe || e in Se || e === `ex`
    );
  },
  D = function (t, n) {
    var r;
    if (t.unit in xe)
      r = xe[t.unit] / n.fontMetrics().ptPerEm / n.sizeMultiplier;
  ...
  Oe = function (t) {
    var r = `<` + t;
    this.classes.length && (r += ` class="` + a(we(this.classes)) + `"`);
    var i = ``;
    for (var o of Object.keys(this.style))
      i += n(o) + `:` + this.style[o] + `;`;
    i && (r += ` style="` + a(i) + `"`);
    for (var s of Object.keys(this.attributes)) {
      if (De.test(s)) throw new e(`Invalid attribute name '` + s + `'`);
      r += ` ` + s + `="` + a(this.attributes[s]) + `"`;
    }
    r += `>`;
  ...
  ke = class {
    constructor(e, t, n, r) {
      (Te.call(this, e, n, r), (this.children = t || []));
    }
    setAttribute(e, t) {
      this.attributes[e] = t;
    }
  ...
  je = class {
    ...
    toMarkup() {
      var e = `<img src="` + a(this.src) + `"` + (` alt="` + a(this.alt) + `"`),
        t = ``;
      for (var r of Object.keys(this.style))
        t += n(r) + `:` + this.style[r] + `;`;
      return (t && (e += ` style="` + a(t) + `"`), (e += `'/>`), e);
    }
  },
  Me = { î: `ı̂`, ï: `ı̈`, í: `ı́`, ì: `ı̀` },
  Ne = class {
    constructor(e, t, n, r, i, a, o, s) {
      ...
      (c && this.classes.push(c + `_fallback`),
        /[îïíì]/.test(this.text) && (this.text = Me[this.text]));
    }
    hasClass(e) {
      return this.classes.includes(e);
    }
    toNode() {
      ...
      for (var n of Object.keys(this.style))
        ((t ||= document.createElement(`span`)), (t.style[n] = this.style[n]));
    ...
    toMarkup() {
      var e = !1,
        t = `<span`;
      this.classes.length &&
        ((e = !0), (t += ` class="`), (t += a(we(this.classes))), (t += `"`));
      var r = ``;
      this.italic > 0 && (r += `margin-right:` + O(this.italic) + `;`);
      for (var i of Object.keys(this.style))
        r += n(i) + `:` + this.style[i] + `;`;
      r && ((e = !0), (t += ` style="` + a(r) + `"`));
      var o = a(this.text);
    ...
    toNode() {
      ...
      return (
        this.alternate
          ...
          : e.setAttribute(`d`, ve[this.pathName]),
        e
      );
    }
    toMarkup() {
...
var ze = (e) => e instanceof ke || e instanceof Ae || e instanceof be,
  Be = {
    "AMS-Regular": {
      32: [0, 0, 0, 0, 0.25],
...
function We(e, t, n) {
  if (!Be[t]) throw Error(`Font metrics not found for font: ` + t + `.`);
  var r = e.charCodeAt(0),
    i = Be[t][r];
  if (
    (!i && e[0] in He && ((r = He[e[0]].charCodeAt(0)), (i = Be[t][r])),
    !i && n === `text` && se(r) && (i = Be[t][77]),
    i)
  )
...
function Ke(e) {
  var t = e >= 5 ? 0 : e >= 3 ? 1 : 2;
  if (!Ge[t]) {
    var n = (Ge[t] = { cssEmPerMu: Ve.quad[t] / 18 });
    for (var r in Ve) Ve.hasOwnProperty(r) && (n[r] = Ve[r][t]);
  }
  return Ge[t];
}
var qe = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  Je = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  k = { math: {}, text: {} };
function A(e, t, n, r, i, a) {
  ((k[e][i] = { font: t, group: n, replace: r }),
    a && r && (k[e][r] = k[e][i]));
}
var j = `math`,
  M = `text`,
...
(A(j, N, z, `≡`, `\\equiv`, !0),
  ...
  A(j, N, z, `⋈`, `\\bowtie`, !0),
  A(j, N, z, `⌣`, `\\smile`, !0),
  A(j, N, z, `⊑`, `\\sqsubseteq`, !0),
  A(j, N, z, `⊒`, `\\sqsupseteq`, !0),
  A(j, N, z, `≐`, `\\doteq`, !0),
  A(j, N, z, `⌢`, `\\frown`, !0),
  A(j, N, z, `∋`, `\\ni`, !0),
  A(j, N, z, `∝`, `\\propto`, !0),
  ...
  A(j, N, B, `‡`, `\\ddag`),
  A(M, N, B, `‡`, `\\ddag`),
  A(M, N, B, `‡`, `\\textdaggerdbl`),
  A(j, N, Ye, `⎱`, `\\rmoustache`, !0),
  A(j, N, Ze, `⎰`, `\\lmoustache`, !0),
  A(j, N, Ye, `⟯`, `\\rgroup`, !0),
  A(j, N, Ze, `⟮`, `\\lgroup`, !0),
  A(j, N, I, `∓`, `\\mp`, !0),
  A(j, N, I, `⊖`, `\\ominus`, !0),
  ...
  A(j, N, I, `⨿`, `\\amalg`),
  A(j, N, I, `&`, `\\And`),
  A(j, N, z, `⟵`, `\\longleftarrow`, !0),
  A(j, N, z, `⇐`, `\\Leftarrow`, !0),
  A(j, N, z, `⟸`, `\\Longleftarrow`, !0),
  A(j, N, z, `⟶`, `\\longrightarrow`, !0),
  A(j, N, z, `⇒`, `\\Rightarrow`, !0),
  A(j, N, z, `⟹`, `\\Longrightarrow`, !0),
  A(j, N, z, `↔`, `\\leftrightarrow`, !0),
  A(j, N, z, `⟷`, `\\longleftrightarrow`, !0),
  A(j, N, z, `⇔`, `\\Leftrightarrow`, !0),
  A(j, N, z, `⟺`, `\\Longleftrightarrow`, !0),
  A(j, N, z, `↦`, `\\mapsto`, !0),
  A(j, N, z, `⟼`, `\\longmapsto`, !0),
  A(j, N, z, `↗`, `\\nearrow`, !0),
  A(j, N, z, `↩`, `\\hookleftarrow`, !0),
  A(j, N, z, `↪`, `\\hookrightarrow`, !0),
  A(j, N, z, `↘`, `\\searrow`, !0),
  A(j, N, z, `↼`, `\\leftharpoonup`, !0),
  A(j, N, z, `⇀`, `\\rightharpoonup`, !0),
  A(j, N, z, `↙`, `\\swarrow`, !0),
  A(j, N, z, `↽`, `\\leftharpoondown`, !0),
  A(j, N, z, `⇁`, `\\rightharpoondown`, !0),
  A(j, N, z, `↖`, `\\nwarrow`, !0),
  A(j, N, z, `⇌`, `\\rightleftharpoons`, !0),
  A(j, P, z, `≮`, `\\nless`, !0),
  A(j, P, z, ``, `\\@nleqslant`),
  A(j, P, z, ``, `\\@nleqq`),
  A(j, P, z, `⪇`, `\\lneq`, !0),
  ...
  A(j, P, z, `⋬`, `\\ntrianglelefteq`, !0),
  A(j, P, z, `⊊`, `\\subsetneq`, !0),
  A(j, P, z, ``, `\\@varsubsetneq`),
  A(j, P, z, `⫋`, `\\subsetneqq`, !0),
  A(j, P, z, ``, `\\@varsubsetneqq`),
  A(j, P, z, `≯`, `\\ngtr`, !0),
  A(j, P, z, ``, `\\@ngeqslant`),
  A(j, P, z, ``, `\\@ngeqq`),
  A(j, P, z, `⪈`, `\\gneq`, !0),
  ...
  A(j, P, z, `⋡`, `\\nsucceq`, !0),
  A(j, P, z, `⋩`, `\\succnsim`, !0),
  A(j, P, z, `⪺`, `\\succnapprox`, !0),
  A(j, P, z, `≆`, `\\ncong`, !0),
  A(j, P, z, ``, `\\@nshortparallel`),
  A(j, P, z, `∦`, `\\nparallel`, !0),
  A(j, P, z, `⊯`, `\\nVDash`, !0),
  A(j, P, z, `⋫`, `\\ntriangleright`),
  A(j, P, z, `⋭`, `\\ntrianglerighteq`, !0),
  A(j, P, z, ``, `\\@nsupseteqq`),
  A(j, P, z, `⊋`, `\\supsetneq`, !0),
  A(j, P, z, ``, `\\@varsupsetneq`),
  A(j, P, z, `⫌`, `\\supsetneqq`, !0),
  A(j, P, z, ``, `\\@varsupsetneqq`),
  A(j, P, z, `⊮`, `\\nVdash`, !0),
  A(j, P, z, `⪵`, `\\precneqq`, !0),
  A(j, P, z, `⪶`, `\\succneqq`, !0),
  A(j, P, z, ``, `\\@nsubseteqq`),
  ...
  A(j, P, B, `®`, `\\circledR`),
  A(M, P, B, `®`, `\\circledR`),
  A(j, P, B, `∡`, `\\measuredangle`, !0),
  A(j, P, B, `∄`, `\\nexists`),
  A(j, P, B, `℧`, `\\mho`),
  A(j, P, B, `Ⅎ`, `\\Finv`, !0),
  A(j, P, B, `⅁`, `\\Game`, !0),
  A(j, P, B, `‵`, `\\backprime`),
  A(j, P, B, `▲`, `\\blacktriangle`),
  A(j, P, B, `▼`, `\\blacktriangledown`),
  A(j, P, B, `■`, `\\blacksquare`),
  A(j, P, B, `⧫`, `\\blacklozenge`),
  A(j, P, B, `★`, `\\bigstar`),
  A(j, P, B, `∢`, `\\sphericalangle`, !0),
  A(j, P, B, `∁`, `\\complement`, !0),
  A(j, P, B, `ð`, `\\eth`, !0),
  A(M, N, B, `ð`, `ð`),
  A(j, P, B, `╱`, `\\diagup`),
  A(j, P, B, `╲`, `\\diagdown`),
  ...
  A(j, P, z, `≦`, `\\leqq`, !0),
  A(j, P, z, `⩽`, `\\leqslant`, !0),
  A(j, P, z, `⪕`, `\\eqslantless`, !0),
  A(j, P, z, `≲`, `\\lesssim`, !0),
  A(j, P, z, `⪅`, `\\lessapprox`, !0),
  A(j, P, z, `≊`, `\\approxeq`, !0),
  A(j, P, I, `⋖`, `\\lessdot`),
  A(j, P, z, `⋘`, `\\lll`, !0),
  A(j, P, z, `≶`, `\\lessgtr`, !0),
  A(j, P, z, `⋚`, `\\lesseqgtr`, !0),
  A(j, P, z, `⪋`, `\\lesseqqgtr`, !0),
  A(j, P, z, `≑`, `\\doteqdot`),
  A(j, P, z, `≓`, `\\risingdotseq`, !0),
  A(j, P, z, `≒`, `\\fallingdotseq`, !0),
  A(j, P, z, `∽`, `\\backsim`, !0),
  A(j, P, z, `⋍`, `\\backsimeq`, !0),
  A(j, P, z, `⫅`, `\\subseteqq`, !0),
  A(j, P, z, `⋐`, `\\Subset`, !0),
  A(j, P, z, `⊏`, `\\sqsubset`, !0),
  A(j, P, z, `≼`, `\\preccurlyeq`, !0),
  A(j, P, z, `⋞`, `\\curlyeqprec`, !0),
  A(j, P, z, `≾`, `\\precsim`, !0),
  A(j, P, z, `⪷`, `\\precapprox`, !0),
  A(j, P, z, `⊲`, `\\vartriangleleft`),
  A(j, P, z, `⊴`, `\\trianglelefteq`),
  A(j, P, z, `⊨`, `\\vDash`, !0),
  A(j, P, z, `⊪`, `\\Vvdash`, !0),
  A(j, P, z, `⌣`, `\\smallsmile`),
  A(j, P, z, `⌢`, `\\smallfrown`),
  ...
  A(j, P, z, `⋑`, `\\Supset`, !0),
  A(j, P, z, `⊐`, `\\sqsupset`, !0),
  A(j, P, z, `≽`, `\\succcurlyeq`, !0),
  A(j, P, z, `⋟`, `\\curlyeqsucc`, !0),
  A(j, P, z, `≿`, `\\succsim`, !0),
  A(j, P, z, `⪸`, `\\succapprox`, !0),
  A(j, P, z, `⊳`, `\\vartriangleright`),
  A(j, P, z, `⊵`, `\\trianglerighteq`),
  A(j, P, z, `⊩`, `\\Vdash`, !0),
  A(j, P, z, `∣`, `\\shortmid`),
  A(j, P, z, `∥`, `\\shortparallel`),
  A(j, P, z, `≬`, `\\between`, !0),
  A(j, P, z, `⋔`, `\\pitchfork`, !0),
  A(j, P, z, `∝`, `\\varpropto`),
  A(j, P, z, `◀`, `\\blacktriangleleft`),
  A(j, P, z, `∴`, `\\therefore`, !0),
  A(j, P, z, `∍`, `\\backepsilon`),
  A(j, P, z, `▶`, `\\blacktriangleright`),
  A(j, P, z, `∵`, `\\because`, !0),
  A(j, P, z, `⋘`, `\\llless`),
  A(j, P, z, `⋙`, `\\gggtr`),
  A(j, P, I, `⊲`, `\\lhd`),
  ...
  A(j, P, z, `≑`, `\\Doteq`, !0),
  A(j, P, I, `∔`, `\\dotplus`, !0),
  A(j, P, I, `∖`, `\\smallsetminus`),
  A(j, P, I, `⋒`, `\\Cap`, !0),
  A(j, P, I, `⋓`, `\\Cup`, !0),
  A(j, P, I, `⩞`, `\\doublebarwedge`, !0),
  A(j, P, I, `⊟`, `\\boxminus`, !0),
  A(j, P, I, `⊞`, `\\boxplus`, !0),
  A(j, P, I, `⋇`, `\\divideontimes`, !0),
  A(j, P, I, `⋉`, `\\ltimes`, !0),
  A(j, P, I, `⋊`, `\\rtimes`, !0),
  A(j, P, I, `⋋`, `\\leftthreetimes`, !0),
  A(j, P, I, `⋌`, `\\rightthreetimes`, !0),
  A(j, P, I, `⋏`, `\\curlywedge`, !0),
  A(j, P, I, `⋎`, `\\curlyvee`, !0),
  A(j, P, I, `⊝`, `\\circleddash`, !0),
  A(j, P, I, `⊛`, `\\circledast`, !0),
  A(j, P, I, `⋅`, `\\centerdot`),
  A(j, P, I, `⊺`, `\\intercal`, !0),
  A(j, P, I, `⋒`, `\\doublecap`),
  A(j, P, I, `⋓`, `\\doublecup`),
  A(j, P, I, `⊠`, `\\boxtimes`, !0),
  A(j, P, z, `⇢`, `\\dashrightarrow`, !0),
  A(j, P, z, `⇠`, `\\dashleftarrow`, !0),
  A(j, P, z, `⇇`, `\\leftleftarrows`, !0),
  A(j, P, z, `⇆`, `\\leftrightarrows`, !0),
  A(j, P, z, `⇚`, `\\Lleftarrow`, !0),
  A(j, P, z, `↞`, `\\twoheadleftarrow`, !0),
  A(j, P, z, `↢`, `\\leftarrowtail`, !0),
  A(j, P, z, `↫`, `\\looparrowleft`, !0),
  A(j, P, z, `⇋`, `\\leftrightharpoons`, !0),
  A(j, P, z, `↶`, `\\curvearrowleft`, !0),
  A(j, P, z, `↺`, `\\circlearrowleft`, !0),
  A(j, P, z, `↰`, `\\Lsh`, !0),
  A(j, P, z, `⇈`, `\\upuparrows`, !0),
  A(j, P, z, `↿`, `\\upharpoonleft`, !0),
  A(j, P, z, `⇃`, `\\downharpoonleft`, !0),
  A(j, N, z, `⊶`, `\\origof`, !0),
  A(j, N, z, `⊷`, `\\imageof`, !0),
  A(j, P, z, `⊸`, `\\multimap`, !0),
  A(j, P, z, `↭`, `\\leftrightsquigarrow`, !0),
  A(j, P, z, `⇉`, `\\rightrightarrows`, !0),
  A(j, P, z, `⇄`, `\\rightleftarrows`, !0),
  A(j, P, z, `↠`, `\\twoheadrightarrow`, !0),
  A(j, P, z, `↣`, `\\rightarrowtail`, !0),
  A(j, P, z, `↬`, `\\looparrowright`, !0),
  A(j, P, z, `↷`, `\\curvearrowright`, !0),
  A(j, P, z, `↻`, `\\circlearrowright`, !0),
  A(j, P, z, `↱`, `\\Rsh`, !0),
  A(j, P, z, `⇊`, `\\downdownarrows`, !0),
  A(j, P, z, `↾`, `\\upharpoonright`, !0),
  A(j, P, z, `⇂`, `\\downharpoonright`, !0),
  A(j, P, z, `⇝`, `\\rightsquigarrow`, !0),
  A(j, P, z, `⇝`, `\\leadsto`),
  A(j, P, z, `⇛`, `\\Rrightarrow`, !0),
  A(j, P, z, `↾`, `\\restriction`),
  A(j, N, B, `‘`, "`"),
  A(j, N, B, `$`, `\\$`),
  A(M, N, B, `$`, `\\$`),
  ...
  A(j, N, L, `ψ`, `\\psi`, !0),
  A(j, N, L, `ω`, `\\omega`, !0),
  A(j, N, L, `ε`, `\\varepsilon`, !0),
  A(j, N, L, `ϑ`, `\\vartheta`, !0),
  A(j, N, L, `ϖ`, `\\varpi`, !0),
  A(j, N, L, `ϱ`, `\\varrho`, !0),
  A(j, N, L, `ς`, `\\varsigma`, !0),
  A(j, N, L, `φ`, `\\varphi`, !0),
  A(j, N, I, `∗`, `*`, !0),
  A(j, N, I, `+`, `+`),
  A(j, N, I, `−`, `-`, !0),
  ...
  A(j, N, B, `∂`, `\\partial`, !0),
  A(j, N, I, `⊘`, `\\oslash`, !0),
  A(j, P, I, `⊚`, `\\circledcirc`, !0),
  A(j, P, I, `⊡`, `\\boxdot`, !0),
  A(j, N, I, `△`, `\\bigtriangleup`),
  A(j, N, I, `▽`, `\\bigtriangledown`),
  A(j, N, I, `†`, `\\dagger`),
  A(j, N, I, `⋄`, `\\diamond`),
  A(j, N, I, `⋆`, `\\star`),
  A(j, N, I, `◃`, `\\triangleleft`),
  A(j, N, I, `▹`, `\\triangleright`),
  A(j, N, Ze, `{`, `\\{`),
  A(M, N, B, `{`, `\\{`),
  A(M, N, B, `{`, `\\textbraceleft`),
  A(j, N, Ye, `}`, `\\}`),
  A(M, N, B, `}`, `\\}`),
  A(M, N, B, `}`, `\\textbraceright`),
  A(j, N, Ze, `{`, `\\lbrace`),
  A(j, N, Ye, `}`, `\\rbrace`),
  A(j, N, Ze, `[`, `\\lbrack`, !0),
  A(M, N, B, `[`, `\\lbrack`, !0),
  ...
  A(j, N, B, `∥`, `\\Vert`),
  A(M, N, B, `∥`, `\\textbardbl`),
  A(M, N, B, `~`, `\\textasciitilde`),
  A(M, N, B, `\\`, `\\textbackslash`),
  A(M, N, B, `^`, `\\textasciicircum`),
  A(j, N, z, `↑`, `\\uparrow`, !0),
  A(j, N, z, `⇑`, `\\Uparrow`, !0),
  A(j, N, z, `↓`, `\\downarrow`, !0),
  A(j, N, z, `⇓`, `\\Downarrow`, !0),
  A(j, N, z, `↕`, `\\updownarrow`, !0),
  A(j, N, z, `⇕`, `\\Updownarrow`, !0),
  A(j, N, R, `∐`, `\\coprod`),
  A(j, N, R, `⋁`, `\\bigvee`),
  A(j, N, R, `⋀`, `\\bigwedge`),
  ...
  A(j, N, R, `⨆`, `\\bigsqcup`),
  A(j, N, R, `∫`, `\\smallint`),
  A(M, N, Xe, `…`, `\\textellipsis`),
  A(j, N, Xe, `…`, `\\mathellipsis`),
  A(M, N, Xe, `…`, `\\ldots`, !0),
  A(j, N, Xe, `…`, `\\ldots`, !0),
  A(j, N, Xe, `⋯`, `\\@cdots`, !0),
  A(j, N, Xe, `⋱`, `\\ddots`, !0),
...
(A(M, N, B, `–`, `--`, !0),
  ...
  A(M, N, B, `—`, `\\textemdash`),
  A(M, N, B, `‘`, "`", !0),
  A(M, N, B, `‘`, `\\textquoteleft`),
  A(M, N, B, `’`, `'`, !0),
  A(M, N, B, `’`, `\\textquoteright`),
  A(M, N, B, `“`, "``", !0),
  A(M, N, B, `“`, `\\textquotedblleft`),
  A(M, N, B, `”`, `''`, !0),
  A(M, N, B, `”`, `\\textquotedblright`),
  A(j, N, B, `°`, `\\degree`, !0),
  A(M, N, B, `°`, `\\degree`),
  A(M, N, B, `°`, `\\textdegree`, !0),
  A(j, N, B, `£`, `\\pounds`),
  A(j, N, B, `£`, `\\mathsterling`, !0),
  A(M, N, B, `£`, `\\pounds`),
  A(M, N, B, `£`, `\\textsterling`, !0),
  A(j, P, B, `✠`, `\\maltese`),
  A(M, P, B, `✠`, `\\maltese`));
...
for (
  var st = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz`, ct = 0;
  ct < st.length;
  ct++
) {
  var lt = st.charAt(ct);
...
for (var V = ``, ut = 0; ut < st.length; ut++) {
  var H = st.charAt(ut);
  ((V = String.fromCharCode(55349, 56320 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56372 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56424 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56580 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56684 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56736 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56788 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56840 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    (V = String.fromCharCode(55349, 56944 + ut)),
    A(j, N, L, H, V),
    A(M, N, B, H, V),
    ut < 26 &&
      ((V = String.fromCharCode(55349, 56632 + ut)),
      A(j, N, L, H, V),
      A(M, N, B, H, V),
      (V = String.fromCharCode(55349, 56476 + ut)),
      A(j, N, L, H, V),
      A(M, N, B, H, V)));
}
...
for (var dt = 0; dt < 10; dt++) {
  var ft = dt.toString();
  ((V = String.fromCharCode(55349, 57294 + dt)),
    A(j, N, L, ft, V),
    A(M, N, B, ft, V),
    (V = String.fromCharCode(55349, 57314 + dt)),
    A(j, N, L, ft, V),
    A(M, N, B, ft, V),
    (V = String.fromCharCode(55349, 57324 + dt)),
    A(j, N, L, ft, V),
    A(M, N, B, ft, V),
    (V = String.fromCharCode(55349, 57334 + dt)),
    A(j, N, L, ft, V),
    A(M, N, B, ft, V));
}
for (var pt = `ÐÞþ`, mt = 0; mt < pt.length; mt++) {
  var ht = pt.charAt(mt);
...
var gt = [
  ...
  vt = (t, n) => {
    ...
    if (119808 <= a && a < 120484) {
      ...
      return [gt[s][2], gt[s][o]];
    } else if (120782 <= a && a <= 120831) {
      var c = Math.floor((a - 120782) / 10);
      return [_t[c][2], _t[c][o]];
    } else if (a === 120485 || a === 120486) return [gt[0][2], gt[0][o]];
    else if (120486 < a && a < 120782) return [``, ``];
    else throw new e(`Unsupported character: ` + t);
  },
  yt = function (e, t, n) {
    if (k[n][e]) {
      var r = k[n][e].replace;
    ...
    return { value: e, metrics: We(e, t, n) };
  },
  bt = function (e, t, n, r, i) {
    ...
    if (o) {
      ...
      ((n === `text` || (r && r.font === `mathit`)) && (c = 0),
        (s = new Ne(e, o.height, o.depth, c, o.skew, o.width, i)));
    } else
      (typeof console < `u` &&
        console.warn(
  ...
  xt = function (e, t, n, r) {
    return (
      r === void 0 && (r = []),
      n.font === `boldsymbol` && yt(e, `Main-Bold`, t).metrics
        ? bt(e, `Main-Bold`, t, n, r.concat([`mathbf`]))
        : e === `\\` || k[t][e].font === `main`
          ? bt(e, `Main-Regular`, t, n, r)
          : bt(e, `AMS-Regular`, t, n, r.concat([`amsrm`]))
    );
  },
  ...
  Ct = function (e, t, n) {
    var r = e.mode,
      ...
      c = ``,
      l = ``;
    if ((i.charCodeAt(0) === 55349 && ([c, l] = vt(i, r)), c.length > 0))
      return bt(i, c, r, t, a.concat(l));
    if (s) {
      var u, d;
      if (s === `boldsymbol`) {
        var f = St(i, r, t, a, n);
        ...
        o
          ? ((u = Ft[s].fontName), (d = [s]))
          : ((u = Pt(s, t.fontWeight, t.fontShape)),
            (d = [s, t.fontWeight, t.fontShape]));
      if (yt(i, u, r).metrics) return bt(i, u, r, t, a.concat(d));
      if (et.hasOwnProperty(i) && u.slice(0, 10) === `Typewriter`) {
        for (var p = [], m = 0; m < i.length; m++)
          p.push(bt(i[m], u, r, t, a.concat(d)));
        return At(p);
      }
    }
    if (n === `mathord`)
      return bt(i, `Math-Italic`, r, t, a.concat([`mathnormal`]));
    if (n === `textord`) {
      var h = k[r][i] && k[r][i].font;
      if (h === `ams`)
        return bt(
          i,
          Pt(`amsrm`, t.fontWeight, t.fontShape),
          r,
          t,
      ...
      if (h === `main` || !h)
        return bt(
          i,
          Pt(`textrm`, t.fontWeight, t.fontShape),
          r,
          t,
          a.concat(t.fontWeight, t.fontShape),
        );
      var g = Pt(h, t.fontWeight, t.fontShape);
      return bt(i, g, r, t, a.concat(g, t.fontWeight, t.fontShape));
    } else throw Error(`unexpected type: ` + n + ` in makeOrd`);
  },
  wt = (e, t) => {
    if (
      we(e.classes) !== we(t.classes) ||
      e.skew !== t.skew ||
      e.maxFontSize !== t.maxFontSize ||
      (e.italic !== 0 && e.hasClass(`mathnormal`))
    )
      return !1;
    ...
    for (var r of Object.keys(e.style))
      if (e.style[r] !== t.style[r]) return !1;
    for (var i of Object.keys(t.style))
      if (e.style[i] !== t.style[i]) return !1;
    return !0;
  },
  Tt = (e) => {
  ...
  U = function (e, t, n, r) {
    var i = new ke(e, t, n, r);
    return (Et(i), i);
  },
  Dt = (e, t, n, r) => new ke(e, t, n, r),
  Ot = function (e, t, n) {
    var r = U([e], [], t);
    return (
      (r.height = Math.max(
      ...
      (r.style.borderBottomWidth = O(r.height)),
      (r.maxFontSize = 1),
      r
    );
  },
  kt = function (e, t, n, r) {
    var i = new Ae(e, t, n, r);
    return (Et(i), i);
  },
  At = function (e) {
    var t = new be(e);
  ...
  jt = function (e, t) {
    return e instanceof be ? U([], [e], t) : e;
  },
  Mt = function (e) {
  ...
  W = function (e, t) {
    for (
      var { children: n, depth: r } = Mt(e), i = 0, a = 0;
      a < n.length;
      a++
    ) {
      var o = n[a];
  ...
  zt = { number: 5, unit: `mu` },
  Bt = {
    mord: { mop: G, mbin: Rt, mrel: zt, minner: G },
    mop: { mord: G, mop: G, mrel: zt, minner: G },
    mbin: { mord: Rt, mop: Rt, mopen: Rt, minner: Rt },
    mrel: { mord: zt, mop: zt, mopen: zt, minner: zt },
    mopen: {},
    mclose: { mop: G, mbin: Rt, mrel: zt, minner: G },
    mpunct: {
      mord: G,
      mop: G,
      mrel: zt,
...
var Kt = function (e) {
  ...
  qt = new Set([`leftmost`, `mbin`, `mopen`, `mrel`, `mop`, `mpunct`]),
  Jt = new Set([`rightmost`, `mrel`, `mclose`, `mpunct`]),
  Yt = {
    display: T.DISPLAY,
    text: T.TEXT,
    script: T.SCRIPT,
  ...
  Zt = function (e, t, n, r) {
    ...
    if (e.length === 1) {
      ...
      l.type === `sizing`
        ...
        : l.type === `styling` && (c = t.havingStyle(Yt[l.style]));
    }
    var u = U([r[0] || `leftmost`], [], t),
      d = U([r[1] || `rightmost`], [], t),
      f = n === `root`;
    return (
      Qt(
        ...
        (e, t) => {
          ...
          n === `mbin` && Jt.has(r)
            ? (t.classes[0] = `mord`)
            : r === `mbin` && qt.has(n) && (e.classes[0] = `mord`);
        },
        { node: u },
        d,
        f,
      ...
      Qt(
        ...
        (e, t) => {
          var n = tn(t),
            r = tn(e),
            i =
              n && r ? (e.hasClass(`mtight`) ? Vt[n]?.[r] : Bt[n]?.[r]) : null;
          if (i) return Nt(i, c);
        },
        { node: u },
        d,
  ...
  Qt = function (e, t, n, r, i) {
    ...
    for (var a = 0; a < e.length; a++) {
      ...
      (c
        ? (n.node = o)
        : i && o.hasClass(`newline`) && (n.node = U([`leftmost`])),
        (n.insertAfter = ((t) => (n) => {
          (e.splice(t + 1, 0, n), a++);
        })(a)));
    }
  ...
  $t = function (e) {
    return e instanceof be ||
      e instanceof Ae ||
      (e instanceof ke && e.hasClass(`enclosing`))
      ? e
      : null;
  },
  en = function (e, t) {
    ...
    if (n) {
      var r = n.children;
      if (r.length) {
        if (t === `right`) return en(r[r.length - 1], `right`);
        if (t === `left`) return en(r[0], `left`);
      }
    }
    return e;
  },
  tn = function (e, t) {
    return e ? (t && (e = en(e, t)), Xt[e.classes[0]] || null) : null;
  },
  nn = function (e, t) {
...
function rn(e, t) {
  var n = U([`base`], e, t),
    r = U([`strut`]);
  return (
    (r.style.height = O(n.height + n.depth)),
    n.depth && (r.style.verticalAlign = O(-n.depth)),
  ...
  for (var a = [], o = [], s = 0; s < r.length; s++)
    if (
      ...
      r[s].hasClass(`newline`) &&
        (o.pop(), o.length > 0 && (a.push(rn(o, t)), (o = [])), a.push(r[s]));
  o.length > 0 && a.push(rn(o, t));
  var l;
  n
    ? ((l = rn(Zt(n, t, !0), t)), (l.classes = [`tag`]), a.push(l))
    : i && a.push(i);
  var u = U([`katex-html`], a);
  if ((u.setAttribute(`aria-hidden`, `true`), l)) {
    var d = l.children[0];
    ((d.style.height = O(u.height + u.depth)),
      u.depth && (d.style.verticalAlign = O(-u.depth)));
  }
  return u;
}
function on(e) {
...
var Y = class {
    ...
    toNode() {
      ...
      for (var n = 0; n < this.children.length; n++)
        if (
          this.children[n] instanceof X &&
          this.children[n + 1] instanceof X
        ) {
          for (
  ...
  cn = new Set([`\\imath`, `\\jmath`]),
  ln = new Set([`mrow`, `mtable`]),
  un = function (e, t, n) {
    return (
      k[t][e] &&
        k[t][e].replace &&
  ...
  fn = function (e, t) {
    ...
    var i = e.text;
    if (cn.has(i)) return null;
    if (k[r][i]) {
      var a = k[r][i].replace;
      a && (i = a);
    }
    var o = Ft[n].fontName;
    return We(i, o, r) ? Ft[n].variant : null;
  };
function pn(e) {
  if (!e) return !1;
...
var mn = function (e, t, n) {
    ...
    for (var i = [], a, o = 0; o < e.length; o++) {
      ...
      if (s instanceof Y && a instanceof Y) {
        if (
          ...
          a.children.push(...s.children);
          continue;
        } else if (pn(s) && a.type === `mn`) {
          a.children.push(...s.children);
          continue;
        } else if (s.type === `mn` && pn(a))
  ...
  Z = function (t, n) {
    ...
    if (Wt[t.type]) return Wt[t.type](t, n);
    throw new e(`Got group of unknown type: '` + t.type + `'`);
  };
function gn(e, t, n, r, i) {
  var a = mn(e, n),
    o =
      a.length === 1 && a[0] instanceof Y && ln.has(a[0].type)
        ? a[0]
        : new Y(`mrow`, a),
    s = new Y(`annotation`, [new X(t)]);
...
var _n = [
  ...
  vn = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
  yn = function (e, t) {
  ...
  bn = class e {
    constructor(t) {
      ((this.style = t.style),
        ...
        (this.sizeMultiplier = vn[this.size - 1]),
    ...
    havingStyle(e) {
      return this.style === e
        ? this
        : this.extend({ style: e, size: yn(this.textSize, e) });
    }
    havingCrampedStyle() {
    ...
    fontMetrics() {
      return ((this._fontMetrics ||= Ke(this.size)), this._fontMetrics);
    }
    getColor() {
...
var xn = function (e) {
  ...
  Cn = function (e, t, n) {
    var r = xn(n),
      i;
    return n.output === `mathml`
      ? gn(e, t, r, n.displayMode, !0)
      : ((i =
          n.output === `html`
            ? U([`katex`], [an(e, r)])
            : U([`katex`], [gn(e, t, r, n.displayMode, !1), an(e, r)])),
        Sn(i, n));
  },
  wn = function (e, t, n) {
    return Sn(U([`katex`], [an(e, xn(n))]), n);
  },
  Tn = {
    widehat: `^`,
    widecheck: `ˇ`,
  ...
  En = function (e) {
    var t = new Y(`mo`, [new X(Tn[e.replace(/^\\/, ``)])]);
  ...
  On = new Set([`widehat`, `widecheck`, `widetilde`, `utilde`]),
  kn = function (e, t) {
    function n() {
      var n = 4e5,
        r = e.label.slice(1);
      if (On.has(r)) {
        var i = e,
          a = i.base.type === `ordgroup` ? i.base.body.length : 1,
          o,
          s,
          c;
        if (a > 5)
          r === `widehat` || r === `widecheck`
            ? ((o = 420), (n = 2364), (c = 0.42), (s = r + `4`))
            : ((o = 312), (n = 2340), (c = 0.34), (s = `tilde4`));
        else {
          var l = [1, 1, 2, 2, 3, 3][a];
          r === `widehat` || r === `widecheck`
            ? ((n = [0, 1062, 2364, 2364, 2364][l]),
              (o = [0, 239, 300, 360, 420][l]),
              (c = [0, 0.24, 0.3, 0.3, 0.36, 0.42][l]),
              (s = r + l))
            : ((n = [0, 600, 1033, 2339, 2340][l]),
              (o = [0, 260, 286, 306, 312][l]),
              (c = [0, 0.26, 0.286, 0.3, 0.306, 0.34][l]),
              (s = `tilde` + l));
        }
        return {
          span: Dt(
        ...
        for (var b = 0; b < g; b++) {
          ...
          ((S.style.height = O(h)), u.push(S));
        }
        return { span: U([`stretchy`], u, t), minWidth: p, height: h };
      }
    }
  ...
  An = function (e, t, n, r, i) {
    ...
    if (/fbox|color|angl/.test(t)) {
      ...
      (/^[bx]cancel$/.test(t) &&
        ...
        (a = Dt([], [new Pe(c, { width: `100%`, height: O(o) })], i)));
    }
...
function Mn(e) {
  return e && (e.type === `atom` || Je.hasOwnProperty(e.type)) ? e : null;
}
var Nn = (e) => {
    if (e instanceof Ne) return e;
    if (ze(e) && e.children.length === 1) return Nn(e.children[0]);
  },
  Pn = (e, t) => {
    var n, r, i;
    e && e.type === `supsub`
    ...
    var a = J(n, t.havingCrampedStyle()),
      o = r.isShifty && c(n),
      s = 0;
    o && (s = Nn(a)?.skew ?? 0);
    var l = r.label === `\\c`,
      u = l ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight),
      d;
    if (r.isStretchy)
      ((d = kn(r, t)),
        (d = W({
      ...
      var f, p;
      (r.label === `\\vec`
        ? ((f = Lt(`vec`, t)), (p = It.vec[1]))
        : ((f = Ct(
            { type: `textord`, mode: r.mode, text: r.label },
            t,
            `textord`,
          )),
          (f = Le(f)),
      ...
      (m || (h -= p / 2),
        (d.style.left = O(h)),
        r.label === `\\textcircled` && (d.style.top = `.2em`),
        (d = W({
          positionType: `firstBaseline`,
          children: [
            { type: `elem`, elem: a },
  ...
  Fn = (e, t) => {
    var n = e.isStretchy ? En(e.label) : new Y(`mo`, [un(e.label, e.mode)]),
      r = new Y(`mover`, [Z(e.base, t), n]);
...
K({
  ...
  mathmlBuilder(e, t) {
    ...
    if (e.body) {
      var i = Ln(Z(e.body, t));
      r = e.below
        ? new Y(`munderover`, [n, Ln(Z(e.below, t)), i])
        : new Y(`mover`, [n, i]);
    } else
      e.below
        ? (r = new Y(`munder`, [n, Ln(Z(e.below, t))]))
        : ((r = Ln()), (r = new Y(`mover`, [n, r])));
    return r;
  },
});
function Rn(e, t) {
...
(K({
  ...
  K({
    ...
    handler(e, t) {
      var { parser: n } = e;
      return { type: `pmb`, mode: n.mode, mclass: Bn(t[0]), body: q(t[0]) };
    },
    htmlBuilder(e, t) {
      var n = Zt(e.body, t, !0),
        r = U([e.mclass], n, t);
    ...
    mathmlBuilder(e, t) {
      var n = new Y(`mstyle`, mn(e.body, t));
...
var Vn = {
  ...
  Hn = () => ({ type: `styling`, body: [], mode: `math`, style: `display` }),
  Un = (e) => e.type === `textord` && e.text === `@`,
  Wn = (e, t) => (e.type === `mathord` || e.type === `atom`) && e.text === t;
function Gn(e, t, n) {
  var r = Vn[e];
  switch (r) {
    case `\\\\cdrightarrow`:
...
function Kn(t) {
  ...
  for (var i = [], a = [i], o = 0; o < n.length; o++) {
    for (var s = n[o], c = Hn(), l = 0; l < s.length; l++)
      if (!Un(s[l])) c.body.push(s[l]);
      else {
        (i.push(c), (l += 1));
        var u = jn(s[l]).text,
          d = [, ,];
...
(K({
  ...
  htmlBuilder(e, t) {
    var n = t.havingStyle(t.style.sup()),
      r = jt(J(e.label, n, t), t);
    return (
      r.classes.push(`cd-label-` + e.side),
      (r.style.bottom = O(0.8 - r.depth)),
      (r.height = 0),
      (r.depth = 0),
      r
    );
  ...
  K({
    ...
    handler(t, n) {
      for (
        var { parser: r } = t, i = Q(n[0], `ordgroup`).body, a = ``, o = 0;
        o < i.length;
        o++
      ) {
        var s = Q(i[o], `textord`);
      ...
      if (c < 0 || c >= 1114111)
        throw new e(`\\@char with invalid code point ` + a);
      return (
        c <= 65535
          ? (l = String.fromCharCode(c))
          : ((c -= 65536),
            (l = String.fromCharCode((c >> 10) + 55296, (c & 1023) + 56320))),
        { type: `textord`, mode: r.mode, text: l }
      );
    },
  }));
var qn = (e, t) => At(Zt(e.body, t.withColor(e.color), !1)),
  Jn = (e, t) => {
    var n = new Y(`mstyle`, mn(e.body, t.withColor(e.color)));
    ...
    htmlBuilder(e, t) {
      ...
      return (
        e.newLine &&
          ...
          e.size && (n.style.marginTop = O(D(e.size, t)))),
        n
      );
    },
    mathmlBuilder(e, t) {
      ...
      return (
        e.newLine &&
          ...
          e.size && n.setAttribute(`height`, O(D(e.size, t)))),
        n
      );
    },
  }));
var Yn = {
  ...
  Xn = (t) => {
    var n = t.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(n))
      throw new e(`Expected a control sequence`, t);
    return n;
  },
  Zn = (e) => {
...
(K({
  ...
  handler(t) {
    ...
    if (Yn[i.text])
      return (
        (r === `\\global` || r === `\\\\globallong`) && (i.text = Yn[i.text]),
        Q(n.parseFunction(), `internal`)
      );
  ...
  K({
    ...
    handler(t) {
      var { parser: n, funcName: r } = t,
        ...
        a = i.text;
      if (/^(?:[\\{}$&#^_]|EOF)$/.test(a))
        throw new e(`Expected a control sequence`, i);
      for (var o = 0, s, c = [[]]; n.gullet.future().text !== `{`; )
        if (((i = n.gullet.popToken()), i.text === `#`)) {
          if (n.gullet.future().text === `{`) {
            ((s = n.gullet.future()), c[o].push(`{`));
            break;
          }
          if (((i = n.gullet.popToken()), !/^[1-9]$/.test(i.text)))
            throw new e(`Invalid argument number "` + i.text + `"`);
          if (parseInt(i.text) !== o + 1)
            throw new e(`Argument number "` + i.text + `" out of order`);
          (o++, c.push([]));
      ...
      return (
        s && l.unshift(s),
        (r === `\\edef` || r === `\\xdef`) &&
          ((l = n.gullet.expandTokens(l)), l.reverse()),
        n.gullet.macros.set(
          a,
          { tokens: l, numArgs: o, delimiters: c },
          r === Yn[r],
        ),
        { type: `internal`, mode: n.mode }
      );
    },
  }),
  K({
    ...
    handler(e) {
      var { parser: t, funcName: n } = e,
        r = Xn(t.gullet.popToken());
      return (
        t.gullet.consumeSpaces(),
        Qn(t, r, Zn(t), n === `\\\\globallet`),
...
var $n = function (e, t, n) {
    var r = We((k.math[e] && k.math[e].replace) || e, t, n);
    if (!r)
  ...
  er = function (e, t, n, r) {
    var i = n.havingBaseStyle(t),
      a = U(r.concat(i.sizingClasses(n)), [e], n),
  ...
  nr = function (e, t, n, r, i, a) {
    var o = er(bt(e, `Main-Regular`, i, r), t, r, a);
    return (n && tr(o, r, t), o);
  },
  rr = function (e, t, n, r) {
    return bt(e, `Size` + t + `-Regular`, n, r);
  },
  ir = function (e, t, n, r, i, a) {
    var o = rr(e, t, i, r),
      s = er(U([`delimsizing`, `size` + t], [o], r), T.TEXT, r, a);
    return (n && tr(s, r, T.TEXT), s);
  },
  ar = function (e, t, n) {
    return {
      type: `elem`,
      elem: U(
        [
          `delimsizinginner`,
          t === `Size1-Regular` ? `delim-size1` : `delim-size4`,
        ],
        [U([], [bt(e, t, n)])],
      ),
    };
  ...
  or = function (e, t, n) {
    var r = Be[`Size4-Regular`][e.charCodeAt(0)]
        ? Be[`Size4-Regular`][e.charCodeAt(0)][4]
        : Be[`Size1-Regular`][e.charCodeAt(0)][4],
      i = Dt(
        [],
        [
          new Pe([new Fe(`inner`, _e(e, Math.round(1e3 * t)))], {
            width: O(r),
            height: O(t),
            style: `width:` + O(r),
  ...
  sr = 0.008,
  cr = { type: `kern`, size: -1 * sr },
  lr = new Set([`|`, `\\lvert`, `\\rvert`, `\\vert`]),
  ur = new Set([`\\|`, `\\lVert`, `\\rVert`, `\\Vert`]),
  dr = function (e, t, n, r, i, a) {
    ...
    if (u.length > 0) {
      ...
      ((E.height = re / 1e3),
        (E.style.width = oe),
        (E.style.height = se),
        w.push({ type: `elem`, elem: E }));
    } else {
      if ((w.push(ar(l, f, i)), w.push(cr), s === null)) {
        var ce = C - m - v + 2 * sr;
        w.push(or(c, ce, r));
      } else {
        var le = (C - m - v - y) / 2 + 2 * sr;
        (w.push(or(c, le, r)),
          w.push(cr),
          w.push(ar(s, f, i)),
          w.push(cr),
      ...
      (w.push(cr), w.push(ar(o, f, i)));
    }
    var ue = r.havingBaseStyle(T.TEXT);
    return er(
      U(
        [`delimsizing`, `mult`],
        [W({ positionType: `bottom`, positionData: te, children: w })],
        ue,
      ),
      T.TEXT,
      r,
  ...
  hr = function (e, t) {
    var n = t.havingBaseSizing(),
      r = Tr(`\\surd`, e * n.sizeMultiplier, Cr, n),
      i = n.sizeMultiplier,
      ...
      r.type === `small`
        ...
        : r.type === `large`
          ? ((l = (1e3 + fr) * yr[r.size]),
            (c = (yr[r.size] + a) / i),
            (s = (yr[r.size] + a + pr) / i),
            (o = mr(`sqrtSize` + r.size, s, l, a, t)),
            (o.style.minWidth = `1.02em`),
            (u = 1 / i))
          : ((s = e + a + pr),
            (c = e + a),
            (l = Math.floor(1e3 * e + a) + fr),
            (o = mr(`sqrtTall`, s, l, a, t)),
  ...
  br = function (t, n, r, i, a) {
    if (
      ...
      return ir(t, n, !1, r, i, a);
    if (_r.has(t)) return dr(t, yr[n], !1, r, i, a);
  ...
  Er = function (e, t, n, r, i, a) {
    e === `<` || e === `\\lt` || e === `⟨`
      ? (e = `\\langle`)
      : (e === `>` || e === `\\gt` || e === `⟩`) && (e = `\\rangle`);
    var o = vr.has(e) ? xr : gr.has(e) ? Cr : Sr,
      s = Tr(e, t, o, r);
    return s.type === `small`
      ? nr(e, s.style, n, r, i, a)
      : s.type === `large`
        ? ir(e, s.size, n, r, i, a)
        : dr(e, t, n, r, i, a);
  },
  Dr = function (e, t, n, r, i, a) {
    var o = r.fontMetrics().axisHeight * r.sizeMultiplier,
      ...
      l = Math.max(t - o, n + o);
    return Er(e, Math.max((l / 500) * s, 2 * l - c), !0, r, i, a);
  },
  Or = {
...
function Ar(t, n) {
  var r = Mn(t);
  if (r && kr.has(r.text)) return r;
  throw r
    ? new e(`Invalid delimiter '` + r.text + `' after '` + n.funcName + `'`, t)
    : new e(`Invalid delimiter type '` + t.type + `'`, t);
}
K({
  type: `delimsizing`,
  names: [
  ...
  handler: (e, t) => {
    ...
    return {
      type: `delimsizing`,
      mode: e.parser.mode,
      size: Or[e.funcName].size,
      mclass: Or[e.funcName].mclass,
      delim: n.text,
    };
  },
  htmlBuilder: (e, t) =>
    e.delim === `.`
      ? U([e.mclass])
      : br(e.delim, e.size, t, e.mode, [e.mclass]),
  mathmlBuilder: (e) => {
    var t = [];
    e.delim !== `.` && t.push(un(e.delim, e.mode));
    var n = new Y(`mo`, t);
    (e.mclass === `mopen` || e.mclass === `mclose`
...
(K({
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      jr(e);
      for (
        var n = Zt(e.body, t, !0, [`mopen`, `mclose`]),
          r = 0,
          i = 0,
          a = !1,
          o = 0;
      ...
      var s =
        e.left === `.`
          ? nn(t, [`mopen`])
          : Dr(e.left, r, i, t, e.mode, [`mopen`]);
      if ((n.unshift(s), a))
        for (var c = 1; c < n.length; c++) {
          var l = n[c].isMiddle;
          l && (n[c] = Dr(l.delim, r, i, l.options, e.mode, []));
        }
      var u;
      if (e.right === `.`) u = nn(t, [`mclose`]);
      else {
        var d = e.rightColor ? t.withColor(e.rightColor) : t;
        u = Dr(e.right, r, i, d, e.mode, [`mclose`]);
      }
      return (n.push(u), U([`minner`], n, t));
    },
    mathmlBuilder: (e, t) => {
      jr(e);
      var n = mn(e.body, t);
      if (e.left !== `.`) {
        var r = new Y(`mo`, [un(e.left, e.mode)]);
        (r.setAttribute(`fence`, `true`), n.unshift(r));
      }
      if (e.right !== `.`) {
        var i = new Y(`mo`, [un(e.right, e.mode)]);
  ...
  K({
    ...
    handler: (t, n) => {
      ...
      if (!t.parser.leftrightDepth)
        throw new e(`\\middle without preceding \\left`, r);
...
var Mr = (e, t) => {
    ...
    if (r === `sout`)
      ...
      var l = D({ number: 0.6, unit: `pt` }, t),
        u = D({ number: 0.35, unit: `ex` }, t),
      ...
      (/box/.test(r)
        ...
        /fbox|boxed|fcolorbox/.test(r)
          ? ((a.style.borderStyle = `solid`), (a.style.borderWidth = O(g)))
          : r === `angl` &&
            g !== 0.049 &&
            ((a.style.borderTopWidth = O(g)),
            (a.style.borderRightWidth = O(g))),
        (o = n.depth + h),
        e.backgroundColor &&
    ...
    return (
      ...
      /cancel/.test(r) && !s
        ? U([`mord`, `cancel-lap`], [_], t)
        : U([`mord`], [_], t)
    );
  },
  Nr = (e, t) => {
    var n = 0,
      r = new Y(e.label.includes(`colorbox`) ? `mpadded` : `menclose`, [
        Z(e.body, t),
      ]);
    switch (e.label) {
      case `\\cancel`:
      ...
      case `\\colorbox`:
        if (
          ...
          r.setAttribute(
            `style`,
            `border: ` + O(i) + ` solid ` + e.borderColor,
          );
        }
        break;
      case `\\xcancel`:
...
var Lr = class e {
  ...
  Rr = class e {
    ...
    range(t, n) {
      return new e(n, Lr.range(this, t));
    }
  };
function zr(e) {
  var t = [];
...
var Br = (t) => {
    if (!t.parser.settings.displayMode)
      throw new e(`{` + t.envName + `} can be used only in display mode.`);
  },
  Vr = new Set([`gather`, `gather*`]);
function Hr(e) {
...
function Ur(t, n, r) {
  ...
  if (
    ...
    if (m == null) s = 1;
      ...
      throw new e(`Invalid \\arraystretch: ` + m);
  }
  t.gullet.beginGroup();
  var h = [],
    g = [h],
  ...
  function x() {
    y &&
      (t.gullet.macros.get(`\\df@tag`)
        ? (y.push(t.subparse([new Rr(`\\df@tag`)])),
          t.gullet.macros.set(`\\df@tag`, void 0, !0))
        : y.push(!!l && t.gullet.macros.get(`\\@eqnsw`) === `1`));
  }
  for (b(), v.push(zr(t)); ; ) {
    var S = t.parseExpression(!1, u ? `\\end` : `\\\\`);
    (t.gullet.endGroup(), t.gullet.beginGroup());
    var C = { type: `ordgroup`, mode: t.mode, body: S };
    (r && (C = { type: `styling`, mode: t.mode, style: r, body: [C] }),
      h.push(C));
    var ee = t.fetch().text;
    if (ee === `&`) {
      if (f && h.length === f) {
      ...
      t.consume();
      var te = void 0;
      (t.gullet.future().text !== ` ` && (te = t.parseSizeGroup(!0)),
        _.push(te ? te.value : null),
        x(),
        v.push(zr(t)),
        (h = []),
        g.push(h),
...
var Gr = function (t, n) {
    var r,
      ...
      c = Array(a),
      l = [],
      u = Math.max(n.fontMetrics().arrayRuleWidth, n.minRuleThickness),
      d = 1 / n.fontMetrics().ptPerEm,
      f = 5 * d;
    t.colSeparationType &&
      t.colSeparationType === `small` &&
      (f =
        0.2778 * (n.havingStyle(T.SCRIPT).sizeMultiplier / n.sizeMultiplier));
    var p =
        t.colSeparationType === `CD` ? D({ number: 3, unit: `ex` }, n) : 12 * d,
      m = 3 * d,
      h = t.arraystretch * p,
      g = 0.7 * h,
      _ = 0.3 * h,
    ...
    function y(e) {
      for (var t = 0; t < e.length; ++t)
        (t > 0 && (v += 0.25), l.push({ pos: v, isDashed: e[t] }));
    }
    for (y(o[0]), r = 0; r < t.body.length; ++r) {
      ...
      for (i = 0; i < b.length; ++i) {
        var ee = J(b[i], n);
        (S < ee.depth && (S = ee.depth),
          x < ee.height && (x = ee.height),
          (C[i] = ee));
      }
      var te = t.rowGaps[r],
        w = 0;
      (te && ((w = D(te, n)), w > 0 && ((w += _), S < w && (S = w), (w = 0))),
        t.addJot && r < t.body.length - 1 && (S += m),
        (C.height = x),
        (C.depth = S),
        (v += x),
        (C.pos = v),
    ...
    var ne = v / 2 + n.fontMetrics().axisHeight,
      re = t.cols || [],
      ie = [],
      ae,
      oe,
    ...
    if (t.tags && t.tags.some((e) => e))
      for (r = 0; r < a; ++r) {
        ...
        ((ue =
          ...
          (ue.depth = E.depth),
          (ue.height = E.height),
          se.push({ type: `elem`, elem: ue, shift: ce }));
      }
    for (i = 0, oe = 0; i < s || oe < re.length; ++i, ++oe) {
      for (var de = re[oe], fe = !0; (pe = de)?.type === `separator`; ) {
        ...
        if (
          (fe ||
            ((ae = U([`arraycolsep`], [])),
            (ae.style.width = O(n.fontMetrics().doubleRuleSep)),
            ie.push(ae)),
          de.separator === `|` || de.separator === `:`)
        ) {
          var me = de.separator === `|` ? `solid` : `dashed`,
            he = U([`vertical-separator`], [], n);
          ((he.style.height = O(v)),
            (he.style.borderRightWidth = O(u)),
            (he.style.borderRightStyle = me),
            (he.style.margin = `0 ` + O(-u / 2)));
          var ge = v - ne;
      ...
      if (!(i >= s)) {
        ...
        for (r = 0; r < a; ++r) {
          ...
          if (be) {
            ...
            ((be.depth = ye.depth),
              (be.height = ye.height),
              ve.push({ type: `elem`, elem: be, shift: xe }));
          }
        }
        var Se = W({ positionType: `individualShift`, children: ve }),
          Ce = U([`col-align-` + (de?.align || `c`)], [Se]);
        (ie.push(Ce),
          (i < s - 1 || t.hskipBeforeAndAfter) &&
            ((_e = de?.postgap ?? f),
            _e !== 0 &&
              ((ae = U([`arraycolsep`], [])),
              (ae.style.width = O(_e)),
    ...
    if (l.length > 0) {
      for (
        ...
        var Oe = l.pop(),
          ke = Oe.pos - ne;
        Oe.isDashed
          ? De.push({ type: `elem`, elem: Ee, shift: ke })
          : De.push({ type: `elem`, elem: Te, shift: ke });
      }
      we = W({ positionType: `individualShift`, children: De });
    }
    if (se.length === 0) return U([`mord`], [we], n);
    var Ae = U(
      [`tag`],
      [W({ positionType: `individualShift`, children: se })],
      n,
    );
    return At([we, Ae]);
  },
  ...
  qr = function (e, t) {
    for (
      var n = [],
        r = new Y(`mtd`, [], [`mtr-glue`]),
        i = new Y(`mtd`, [], [`mml-eqn-num`]),
        a = 0;
      a < e.body.length;
      a++
    ) {
      for (var o = e.body[a], s = [], c = 0; c < o.length; c++)
        s.push(new Y(`mtd`, [Z(o[c], t)]));
      (e.tags &&
        e.tags[a] &&
        (s.unshift(r), s.push(r), e.leqno ? s.unshift(i) : s.push(i)),
        n.push(new Y(`mtr`, s)));
    }
    var l = new Y(`mtable`, n),
      u =
        e.arraystretch === 0.5
          ? 0.1
    ...
    if (e.cols && e.cols.length > 0) {
      ...
      for (var v = g; v < _; v++) {
        var y = p[v];
        y.type === `align`
          ? ((f += Kr[y.align]), h && (m += `none `), (h = !0))
          : y.type === `separator` &&
            (h &&= ((m += y.separator === `|` ? `solid ` : `dashed `), !1));
      }
      (l.setAttribute(`columnalign`, f.trim()),
        /[sd]/.test(m) && l.setAttribute(`columnlines`, m.trim()));
    }
    if (e.colSeparationType === `align`) {
      for (var b = e.cols || [], x = ``, S = 1; S < b.length; S++)
        x += S % 2 ? `0em ` : `1em `;
    ...
    var C = ``,
      ee = e.hLinesBeforeRow;
    ((d += ee[0].length > 0 ? `left ` : ``),
      (d += ee[ee.length - 1].length > 0 ? `right ` : ``));
    for (var te = 1; te < ee.length - 1; te++)
      C += ee[te].length === 0 ? `none ` : ee[te][0] ? `dashed ` : `solid `;
    return (
      /[sd]/.test(C) && l.setAttribute(`rowlines`, C.trim()),
      d !== `` &&
        ((l = new Y(`menclose`, [l])), l.setAttribute(`notation`, d.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((l = new Y(`mstyle`, [l])), l.setAttribute(`scriptlevel`, `1`)),
      l
    );
  },
  Jr = function (t, n) {
    t.envName.includes(`ed`) || Br(t);
    var r = [],
      i = t.envName.includes(`at`) ? `alignat` : `align`,
      a = t.envName === `split`,
      o = Ur(
        t.parser,
        {
      ...
      s = 0,
      c = 0,
      l = { type: `ordgroup`, mode: t.mode, body: [] };
    ...
    o.body.forEach(function (t) {
      for (var n = 1; n < t.length; n += 2)
        Q(Q(t[n], `styling`).body[0], `ordgroup`).body.unshift(l);
      if (p) c < t.length && (c = t.length);
      else {
        var r = t.length / 2;
        if (s < r)
          throw new e(
            `Too many math in a row: ` + (`expected ` + s + `, but got ` + r),
            t[0],
          );
      }
    });
    for (var m = 0; m < c; ++m) {
      var h = `r`,
        g = 0;
      (m % 2 == 1 ? (h = `l`) : m > 0 && p && (g = 1),
        (r[m] = { type: `align`, align: h, pregap: g, postgap: 0 }));
    }
...
(Fr({
  ...
  props: { numArgs: 1 },
  handler(t, n) {
    var r = (Mn(n[0]) ? [n[0]] : Q(n[0], `ordgroup`).body).map(function (t) {
        var n = jn(t).text;
        if (`lcr`.includes(n)) return { type: `align`, align: n };
        if (n === `|`) return { type: `separator`, separator: `|` };
        if (n === `:`) return { type: `separator`, separator: `:` };
        throw new e(`Unknown column alignment: ` + n, t);
      }),
      i = { cols: r, hskipBeforeAndAfter: !0, maxNumCols: r.length };
    return Ur(t.parser, i, Wr(t.envName));
  },
  htmlBuilder: Gr,
  mathmlBuilder: qr,
}),
  Fr({
    ...
    handler(t) {
      var n = {
        ...
        r = `c`,
        i = { hskipBeforeAndAfter: !1, cols: [{ type: `align`, align: r }] };
      if (t.envName.charAt(t.envName.length - 1) === `*`) {
        ...
        if ((a.consumeSpaces(), a.fetch().text === `[`)) {
          if (
            ...
            throw new e(`Expected l or c or r`, a.nextToken);
          (a.consume(),
            a.consumeSpaces(),
            a.expect(`]`),
            a.consume(),
            (i.cols = [{ type: `align`, align: r }]));
        }
      }
      var o = Ur(t.parser, i, Wr(t.envName)),
        s = Math.max(0, ...o.body.map((e) => e.length));
      return (
        (o.cols = Array(s).fill({ type: `align`, align: r })),
        n
          ? {
              type: `leftright`,
              mode: t.mode,
  ...
  Fr({
    ...
    handler(t, n) {
      var r = (Mn(n[0]) ? [n[0]] : Q(n[0], `ordgroup`).body).map(function (t) {
        var n = jn(t).text;
        if (`lc`.includes(n)) return { type: `align`, align: n };
        throw new e(`Unknown column alignment: ` + n, t);
      });
      if (r.length > 1) throw new e(`{subarray} can contain only one column`);
      var i = { cols: r, hskipBeforeAndAfter: !1, arraystretch: 0.5 },
        a = Ur(t.parser, i, `script`);
  ...
  Fr({
    ...
    props: { numArgs: 0 },
    handler(e) {
      Vr.has(e.envName) && Br(e);
      var t = {
        cols: [{ type: `align`, align: `c` }],
        addJot: !0,
        colSeparationType: `gather`,
        autoTag: Hr(e.envName),
        emptySingleRow: !0,
...
K({
  ...
  handler(t, n) {
    ...
    if (i === `\\begin`) {
      if (!Yr.hasOwnProperty(o)) throw new e(`No such environment: ` + o, a);
      var c = Yr[o],
        { args: l, optArgs: u } = r.parseArguments(`\\begin{` + o + `}`, c),
        d = { mode: r.mode, envName: o, parser: r },
        f = c.handler(d, l, u);
      r.expect(`\\end`, !1);
      var p = r.nextToken,
        m = Q(r.parseFunction(), `environment`);
      if (m.name !== o)
        throw new e(
...
var $r = (e, t) => {
    ...
    e.hasBarLine
      ? (e.barSize
          ? ((d = D(e.barSize, t)), (u = Ot(`frac-line`, t, d)))
          : (u = Ot(`frac-line`, t)),
        (d = u.height),
        (f = u.height))
      : ((u = null), (d = 0), (f = t.fontMetrics().defaultRuleThickness));
    var p, m, h;
    n.size === T.DISPLAY.size
    ...
    var b =
        n.size === T.DISPLAY.size
          ...
          : n.size === T.SCRIPTSCRIPT.size
            ? t.havingStyle(T.SCRIPT).fontMetrics().delim2
            : t.fontMetrics().delim2,
      x =
        e.leftDelim == null
          ? nn(t, [`mopen`])
          : Er(e.leftDelim, b, !0, t.havingStyle(n), e.mode, [`mopen`]),
      S = e.continued
        ? U([])
        : e.rightDelim == null
          ? nn(t, [`mclose`])
          : Er(e.rightDelim, b, !0, t.havingStyle(n), e.mode, [`mclose`]);
    return U([`mord`].concat(a.sizingClasses(t)), [x, U([`mfrac`], [g]), S], t);
  },
  ei = (e, t) => {
  ...
  ti = (e, t) =>
    t ? { type: `styling`, mode: e.mode, style: t, body: [e] } : e;
(K({
  type: `genfrac`,
  names: [
    `\\cfrac`,
...
var ni = [`display`, `text`, `script`, `scriptscript`],
  ri = function (e) {
    var t = null;
...
(K({
  ...
  handler(e, t) {
    var { parser: n } = e,
      ...
      i = t[5],
      a = Kt(t[0]),
      o = a.type === `atom` && a.family === `open` ? ri(a.text) : null,
      s = Kt(t[1]),
      c = s.type === `atom` && s.family === `close` ? ri(s.text) : null,
      l = Q(t[2], `size`),
      u,
      d = null;
    ...
    } else ((p = Q(p, `textord`)), (f = ni[Number(p.text)]));
    return ti(
      {
        type: `genfrac`,
        mode: n.mode,
...
var ii = (e, t) => {
  ...
  e.type === `supsub`
    ? ((r = e.sup
        ? J(e.sup, t.havingStyle(n.sup()), t)
        : J(e.sub, t.havingStyle(n.sub()), t)),
      (i = Q(e.base, `horizBrace`)))
    : (i = Q(e, `horizBrace`));
  var a = J(i.base, t.havingBaseStyle(T.DISPLAY)),
    o = kn(i, t),
    s;
  if (
    (i.isOver
...
(K({
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      var n = Zt(e.body, t, !1);
      return kt(e.href, [], n, t);
    },
    mathmlBuilder: (e, t) => {
      var n = hn(e.body, t);
      return (
        n instanceof Y || (n = new Y(`mrow`, [n])),
  ...
  K({
    ...
    htmlBuilder(e, t) {
      return At(Zt(e.body, t, !1));
    },
    mathmlBuilder(e, t) {
      return new Y(`mrow`, mn(e.body, t));
    },
  }),
  K({
    type: `html`,
    ...
    handler: (t, n) => {
      var { parser: r, funcName: i, token: a } = t,
        o = Q(n[0], `raw`).string,
        s = n[1];
      r.settings.strict &&
      ...
      return r.settings.isTrusted(c)
        ? { type: `html`, mode: r.mode, attributes: l, body: q(s) }
  ...
  K({
    ...
    htmlBuilder: (e, t) => At(Zt(e.html, t, !1)),
    mathmlBuilder: (e, t) => hn(e.mathml, t),
  }));
var ai = function (t) {
  ...
  if (!Ce(r))
    throw new e(`Invalid unit: '` + r.unit + `' in \\includegraphics.`);
  return r;
};
(K({
  ...
  handler: (t, n, r) => {
    var { parser: i } = t,
      ...
      c = ``;
    if (r[0])
      for (var l = Q(r[0], `raw`).string.split(`,`), u = 0; u < l.length; u++) {
        var d = l[u].split(`=`);
        if (d.length === 2) {
          var f = d[1].trim();
          switch (d[0].trim()) {
            ...
            case `totalheight`:
              ...
              break;
            default:
              throw new e(`Invalid key: '` + d[0] + `' in \\includegraphics.`);
          }
        }
      }
    var p = Q(n[0], `url`).url;
    return (
      ...
      i.settings.isTrusted({ command: `\\includegraphics`, url: p })
        ? {
            type: `includegraphics`,
            mode: i.mode,
            alt: c,
  ...
  mathmlBuilder: (e, t) => {
    ...
    if (
      (e.totalheight.number > 0 &&
        ((i = D(e.totalheight, t) - r), n.setAttribute(`valign`, O(-i))),
      n.setAttribute(`height`, O(r + i)),
      e.width.number > 0)
    ) {
      var a = D(e.width, t);
  ...
  K({
    ...
    htmlBuilder(e, t) {
      return Nt(e.dimension, t);
    },
    mathmlBuilder(e, t) {
      return new sn(D(e.dimension, t));
    },
  }),
  K({
    type: `lap`,
    ...
    htmlBuilder: (e, t) => {
      var n;
      e.alignment === `clap`
        ? ((n = U([], [J(e.body, t)])), (n = U([`inner`], [n], t)))
        : (n = U([`inner`], [J(e.body, t)]));
      var r = U([`fix`], []),
        i = U([e.alignment], [n, r], t),
        a = U([`strut`]);
      return (
        (a.style.height = O(i.height + i.depth)),
        i.depth && (a.style.verticalAlign = O(-i.depth)),
...
K({
  ...
  htmlBuilder: (e, t) => At(Zt(oi(e, t), t, !1)),
  mathmlBuilder: (e, t) => hn(oi(e, t), t),
});
var si = (e, t, n, r, i, a, o) => {
    ...
    if (t) {
      ...
      u = {
        ...
        kern: Math.max(
          ...
          r.fontMetrics().bigOpSpacing3 - d.depth,
        ),
      };
    }
    if (n) {
      ...
      l = {
        ...
        kern: Math.max(
          ...
          r.fontMetrics().bigOpSpacing4 - f.height,
        ),
      };
    }
    var p;
    if (u && l)
      p = W({
        ...
        children: [
          ...
          { type: `elem`, elem: l.elem, marginLeft: O(-a) },
          { type: `kern`, size: l.kern },
          { type: `elem`, elem: e },
          { type: `kern`, size: u.kern },
          { type: `elem`, elem: u.elem, marginLeft: O(a) },
          { type: `kern`, size: r.fontMetrics().bigOpSpacing5 },
        ],
      });
    else if (l)
  ...
  li = (e, t) => {
    ...
    var o = t.style,
      s = !1;
    o.size === T.DISPLAY.size && a.symbol && !ci.has(a.name) && (s = !0);
    var c;
    if (a.symbol) {
      ...
      var p = Zt(a.body, t, !0);
      p.length === 1 && p[0] instanceof Ne
        ? ((c = p[0]), (c.classes[0] = `mop`))
        : (c = U([`mop`], p, t));
    } else {
      for (var m = [], h = 1; h < a.name.length; h++)
        m.push(xt(a.name[h], a.mode, t));
      c = U([`mop`], m, t);
    }
    var g = 0,
      _ = 0;
    return (
      (c instanceof Ne || a.name === `\\oiint` || a.name === `\\oiiint`) &&
        !a.suppressBaseShift &&
        ((g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight),
        (_ = c.italic || 0)),
      i
        ? si(c, n, r, t, o, _, g)
        : (g && ((c.style.position = `relative`), (c.style.top = O(g))), c)
    );
  },
  ui = (e, t) => {
    var n;
    if (e.symbol)
      ((n = new Y(`mo`, [un(e.name, e.mode)])),
        ci.has(e.name) && n.setAttribute(`largeop`, `false`));
    else if (e.body) n = new Y(`mo`, mn(e.body, t));
    else {
      n = new Y(`mi`, [new X(e.name.slice(1))]);
      var r = new Y(`mo`, [un(`⁡`, `text`)]);
      n = e.parentIsSupSub ? new Y(`mrow`, [n, r]) : on([n, r]);
    }
    return n;
  },
  di = {
...
var pi = (e, t) => {
  ...
  return i ? si(o, n, r, t, t.style, 0, 0) : o;
};
(K({
  type: `operatorname`,
  ...
  mathmlBuilder: (e, t) => {
    for (
      var n = mn(e.body, t.withFont(`mathrm`)), r = !0, i = 0;
      i < n.length;
      i++
    ) {
      var a = n[i];
      if (!(a instanceof sn))
        if (a instanceof Y)
          switch (a.type) {
            ...
            case `mo`:
              var o = a.children[0];
              a.children.length === 1 && o instanceof X
                ? (o.text = o.text
                    .replace(/\u2212/, `-`)
                    .replace(/\u2217/, `*`))
                : (r = !1);
    ...
    var c = new Y(`mo`, [un(`⁡`, `text`)]);
    return e.parentIsSupSub ? new Y(`mrow`, [s, c]) : on([s, c]);
  },
}),
  ...
  Gt({
    ...
    htmlBuilder(e, t) {
      return e.semisimple
        ? At(Zt(e.body, t, !1))
        : U([`mord`], Zt(e.body, t, !0), t);
    },
    mathmlBuilder(e, t) {
      return hn(e.body, t, !0);
    },
  }),
  K({
    type: `overline`,
  ...
  K({
    ...
    htmlBuilder: (e, t) => At(Zt(e.body, t.withPhantom(), !1)),
    mathmlBuilder: (e, t) => new Y(`mphantom`, mn(e.body, t)),
  }),
  ...
  K({
    ...
    htmlBuilder: (e, t) =>
      U(
        [`mord`, `rlap`],
        [U([`inner`], [J(e.body, t.withPhantom())]), U([`fix`], [])],
        t,
      ),
    mathmlBuilder: (e, t) => {
      var n = new Y(`mpadded`, [new Y(`mphantom`, mn(q(e.body), t))]);
      return (n.setAttribute(`width`, `0px`), n);
    },
  }),
  K({
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = U([`mord`, `rule`], [], t),
        r = D(e.width, t),
        i = D(e.height, t),
        a = e.shift ? D(e.shift, t) : 0;
      return (
        (n.style.borderRightWidth = O(r)),
        (n.style.borderTopWidth = O(i)),
        (n.style.bottom = O(a)),
        (n.width = r),
        (n.height = i + a),
        (n.depth = -a),
    ...
    mathmlBuilder(e, t) {
      ...
      (o.setAttribute(`mathbackground`, a),
        o.setAttribute(`width`, O(n)),
        o.setAttribute(`height`, O(r)));
      var s = new Y(`mpadded`, [o]);
      return (
        i >= 0
          ? s.setAttribute(`height`, O(i))
          : (s.setAttribute(`height`, O(i)), s.setAttribute(`depth`, O(-i))),
        s.setAttribute(`voffset`, O(i)),
        s
      );
    },
  }));
function mi(e, t, n) {
  for (
    var r = Zt(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0;
    a < r.length;
    a++
  ) {
...
(K({
  ...
  handler: (e, t) => {
    ...
    return { type: `sizing`, mode: i.mode, size: hi.indexOf(r) + 1, body: a };
  },
  htmlBuilder: (e, t) => {
    var n = t.havingSize(e.size);
    return mi(e.body, n, t);
  },
  mathmlBuilder: (e, t) => {
    var n = t.havingSize(e.size),
      r = new Y(`mstyle`, mn(e.body, n));
  ...
  K({
    ...
    htmlBuilder: (e, t) => {
      ...
      if (
        (e.smashHeight && (n.height = 0),
        e.smashDepth && (n.depth = 0),
        e.smashHeight && e.smashDepth)
      )
        return U([`mord`, `smash`], [n], t);
      if (n.children)
        for (var r = 0; r < n.children.length; r++)
          (e.smashHeight && (n.children[r].height = 0),
            e.smashDepth && (n.children[r].depth = 0));
      return U(
        [`mord`],
        [
          W({
  ...
  K({
    ...
    htmlBuilder(e, t) {
      var n = J(e.body, t.havingCrampedStyle());
      (n.height === 0 && (n.height = t.fontMetrics().xHeight), (n = jt(n, t)));
      ...
      var d = W({
        ...
        children: [
          ...
          { type: `kern`, size: -(n.height + u) },
          { type: `elem`, elem: o },
          { type: `kern`, size: s },
        ],
      });
      if (e.index) {
        var f = t.havingStyle(T.SCRIPTSCRIPT),
          p = J(e.index, f, t);
        return U(
          [`mord`, `sqrt`],
          [
            U(
              ...
              [
                W({
                  positionType: `shift`,
                  positionData: -(0.6 * (d.height - d.depth)),
...
K({
  ...
  htmlBuilder(e, t) {
    ...
    return mi(e.body, r, t);
  },
  mathmlBuilder(e, t) {
    var n = gi[e.style],
      r = t.havingStyle(n),
      i = new Y(`mstyle`, mn(e.body, r)),
      a = {
        display: [`0`, `true`],
        text: [`0`, `false`],
        script: [`1`, `false`],
    ...
    return (
      i.setAttribute(`scriptlevel`, a[0]),
      i.setAttribute(`displaystyle`, a[1]),
      i
    );
  },
});
var _i = function (e, t) {
  ...
  return n
    ? n.type === `op`
      ? n.limits && (t.style.size === T.DISPLAY.size || n.alwaysHandleSupSub)
        ? li
        : null
      : n.type === `operatorname`
        ? n.alwaysHandleSupSub && (t.style.size === T.DISPLAY.size || n.limits)
          ? pi
          : null
        : n.type === `accent`
          ? c(n.base)
...
(Gt({
  ...
  htmlBuilder(e, t) {
    ...
    var g = t.style === T.DISPLAY ? u.sup1 : t.style.cramped ? u.sup3 : u.sup2,
      _ = t.sizeMultiplier,
      v = O(0.5 / u.ptPerEm / _),
      y = null;
    if (l) {
      ...
      (o instanceof Ne || b) && (y = O(-o.italic));
    }
    var x;
    if (s && l) {
      ((d = Math.max(d, g, s.depth + 0.25 * u.xHeight)),
        (f = Math.max(f, u.sub2)));
      var S = 4 * u.defaultRuleThickness;
      if (d - s.depth - (l.height - f) < S) {
        f = S - (d - s.depth) + l.height;
        var C = 0.8 * u.xHeight - (d - s.depth);
        C > 0 && ((d += C), (f -= C));
      }
      x = W({
        positionType: `individualShift`,
        children: [
          { type: `elem`, elem: l, shift: f, marginRight: v, marginLeft: y },
          { type: `elem`, elem: s, shift: -d, marginRight: v },
        ],
      });
    } else if (l)
      ((f = Math.max(f, u.sub1, l.height - 0.8 * u.xHeight)),
        (x = W({
          positionType: `shift`,
          positionData: f,
          children: [{ type: `elem`, elem: l, marginLeft: y, marginRight: v }],
        })));
    else if (s)
      ((d = Math.max(d, g, s.depth + 0.25 * u.xHeight)),
        (x = W({
    ...
    return U([tn(o, `right`) || `mord`], [o, U([`msupsub`], [x])], t);
  },
  mathmlBuilder(e, t) {
    var n = !1,
      r,
    ...
    if (n) o = r ? `mover` : `munder`;
      ...
      o =
        (s &&
          s.type === `op` &&
          s.limits &&
          (t.style === T.DISPLAY || s.alwaysHandleSupSub)) ||
        (s &&
          s.type === `operatorname` &&
          s.alwaysHandleSupSub &&
          (s.limits || t.style === T.DISPLAY))
          ? `mover`
          : `msup`;
    } else if (e.sup) {
      var c = e.base;
      o =
        (c && c.type === `op` && c.limits && t.style === T.DISPLAY) ||
        (c &&
          c.type === `operatorname` &&
          c.alwaysHandleSupSub &&
          (t.style === T.DISPLAY || c.limits))
          ? `munderover`
          : `msubsup`;
    } else {
      var l = e.base;
      o =
        (l &&
          l.type === `op` &&
          l.limits &&
          (t.style === T.DISPLAY || l.alwaysHandleSupSub)) ||
        (l &&
          l.type === `operatorname` &&
          l.alwaysHandleSupSub &&
          (l.limits || t.style === T.DISPLAY))
          ? `munder`
          : `msub`;
    }
    return new Y(o, a);
  ...
  Gt({
    type: `atom`,
    htmlBuilder(e, t) {
      return xt(e.text, e.mode, t, [`m` + e.family]);
    },
    mathmlBuilder(e, t) {
      var n = new Y(`mo`, [un(e.text, e.mode)]);
      if (e.family === `bin`) {
        var r = fn(e, t);
...
(Gt({
  type: `mathord`,
  htmlBuilder(e, t) {
    return Ct(e, t, `mathord`);
  },
  mathmlBuilder(e, t) {
    var n = new Y(`mi`, [un(e.text, e.mode, t)]),
      r = fn(e, t) || `italic`;
    return (r !== vi[n.type] && n.setAttribute(`mathvariant`, r), n);
  },
}),
  Gt({
    type: `textord`,
    htmlBuilder(e, t) {
      return Ct(e, t, `textord`);
    },
    mathmlBuilder(e, t) {
      var n = un(e.text, e.mode, t),
        r = fn(e, t) || `normal`,
        i =
          e.mode === `text`
            ? new Y(`mtext`, [n])
            : /[0-9]/.test(e.text)
              ...
              : e.text === `\\prime`
                ? new Y(`mo`, [n])
                : new Y(`mi`, [n]);
      return (r !== vi[i.type] && i.setAttribute(`mathvariant`, r), i);
    },
  }));
...
Gt({
  ...
  htmlBuilder(t, n) {
    if (bi.hasOwnProperty(t.text)) {
      ...
      if (t.mode === `text`) {
        var i = Ct(t, n, `textord`);
        return (i.classes.push(r), i);
      } else return U([`mspace`, r], [xt(t.text, t.mode, n)], n);
    } else if (yi.hasOwnProperty(t.text))
      return U([`mspace`, yi[t.text]], [], n);
    else throw new e(`Unknown type of space "` + t.text + `"`);
  },
  mathmlBuilder(t, n) {
    var r;
    if (bi.hasOwnProperty(t.text)) r = new Y(`mtext`, [new X(`\xA0`)]);
    else if (yi.hasOwnProperty(t.text)) return new Y(`mspace`);
    else throw new e(`Unknown type of space "` + t.text + `"`);
    return r;
  },
});
...
Gt({
  ...
  mathmlBuilder(e, t) {
    var n = new Y(`mtable`, [
      new Y(`mtr`, [
        xi(),
        new Y(`mtd`, [hn(e.body, t)]),
        xi(),
        new Y(`mtd`, [hn(e.tag, t)]),
      ]),
    ]);
...
var Si = {
  ...
  Ci = { "\\textbf": `textbf`, "\\textmd": `textmd` },
  wi = { "\\textit": `textit`, "\\textup": `textup` },
  Ti = (e, t) => {
    var n = e.font;
    return n
      ? Si[n]
        ? t.withTextFontFamily(Si[n])
        : Ci[n]
          ? t.withTextFontWeight(Ci[n])
          : n === `\\emph`
            ? t.fontShape === `textit`
              ? t.withTextFontShape(`textup`)
              : t.withTextFontShape(`textit`)
            : t.withTextFontShape(wi[n])
      : t;
  };
(K({
  type: `text`,
  ...
  htmlBuilder(e, t) {
    var n = Ti(e, t);
    return U([`mord`, `text`], Zt(e.body, n, !0), n);
  },
  mathmlBuilder(e, t) {
    var n = Ti(e, t);
    return hn(e.body, n);
  ...
  K({
    ...
    htmlBuilder(e, t) {
      ...
      return W({
        positionType: `shift`,
        positionData: 0.5 * (n.height - r - (n.depth + r)),
        children: [{ type: `elem`, elem: n }],
      });
    },
    mathmlBuilder(e, t) {
  ...
  K({
    ...
    htmlBuilder(e, t) {
      for (
        var n = Ei(e), r = [], i = t.havingStyle(t.style.text()), a = 0;
        a < n.length;
        a++
      ) {
        var o = n[a];
        (o === `~` && (o = `\\textasciitilde`),
          r.push(bt(o, `Typewriter-Regular`, e.mode, i, [`mord`, `texttt`])));
      }
      return U([`mord`, `text`].concat(i.sizingClasses(t)), Tt(r), i);
    },
    mathmlBuilder(e, t) {
      var n = new Y(`mtext`, [new X(Ei(e))]);
      return (n.setAttribute(`mathvariant`, `monospace`), n);
    },
  }));
var Ei = (e) => e.body.replace(/ /g, e.star ? `␣` : `\xA0`),
  Di = Ht,
  Oi = `[ \r
	]`,
  ki = `\\\\[a-zA-Z@]+`,
...
?)[ \r	]*`,
  ...
  Ii = class {
    constructor(e, t) {
      ((this.input = e),
        (this.settings = t),
        (this.tokenRegex = new RegExp(Fi, `g`)),
        (this.catcodes = { "%": 14, "~": 13 }));
    }
    setCatcode(e, t) {
      this.catcodes[e] = t;
    ...
    lex() {
      ...
      if (n === t.length) return new Rr(`EOF`, new Lr(this, n, n));
      var r = this.tokenRegex.exec(t);
      if (r === null || r.index !== n)
        throw new e(
          `Unexpected character: '` + t[n] + `'`,
          new Rr(t[n], new Lr(this, n, n + 1)),
        );
      var i = r[6] || r[3] || (r[2] ? `\\ ` : ` `);
...
`,
      ...
      return new Rr(i, new Lr(this, n, this.tokenRegex.lastIndex));
    }
  },
  Li = class {
    constructor(e, t) {
    ...
    endGroup() {
      ...
      for (var n in t)
        t.hasOwnProperty(n) &&
          (t[n] == null ? delete this.current[n] : (this.current[n] = t[n]));
    }
    endGroups() {
...
$(`\\char`, function (t) {
  ...
  if (n.text === `'`) ((r = 8), (n = t.popToken()));
    ...
    if (((n = t.popToken()), n.text[0] === `\\`)) i = n.text.charCodeAt(1);
    else if (n.text === `EOF`) throw new e("\\char` missing argument");
    else i = n.text.charCodeAt(0);
  else r = 10;
  if (r) {
    if (((i = zi[n.text]), i == null || i >= r))
      throw new e(`Invalid base-` + r + ` digit ` + n.text);
    for (var a; (a = zi[t.future().text]) != null && a < r; )
      ((i *= r), (i += a), t.popToken());
  }
  return `\\@char{` + i + `}`;
});
var Bi = (t, n, r, i) => {
  ...
  if (((a = t.consumeArg().tokens), a.length === 1 && a[0].text === `[`)) {
    ...
    if (!l.match(/^\s*[0-9]+\s*$/))
      throw new e(`Invalid number of arguments: ` + l);
    ((c = parseInt(l)), (a = t.consumeArg().tokens));
  }
  return ((s && i) || t.macros.set(o, { tokens: a, numArgs: c }), ``);
};
($(`\\newcommand`, (e) => Bi(e, !1, !0, !1)),
  $(`\\renewcommand`, (e) => Bi(e, !0, !1, !1)),
  $(`\\providecommand`, (e) => Bi(e, !0, !0, !0)),
  $(`\\message`, (e) => {
  ...
  $(`\\show`, (e) => {
    var t = e.popToken(),
      n = t.text;
    return (console.log(t, e.macros.get(n), Di[n], k.math[n], k.text[n]), ``);
  }),
  $(`\\bgroup`, `{`),
  $(`\\egroup`, `}`),
  $(`~`, `\\nobreakspace`),
...
$(`\\dots`, function (e) {
  ...
  return (
    n in Vi
      ? (t = Vi[n])
      : (n.slice(0, 4) === `\\not` ||
          (n in k.math && Hi.has(k.math[n].group))) &&
        (t = `\\dotsb`),
    t
  );
});
...
($(`\\dotso`, function (e) {
  return e.future().text in Ui ? `\\ldots\\,` : `\\ldots`;
}),
  $(`\\dotsc`, function (e) {
    var t = e.future().text;
    return t in Ui && t !== `,` ? `\\ldots\\,` : `\\ldots`;
  }),
  $(`\\cdots`, function (e) {
    return e.future().text in Ui ? `\\@cdots\\,` : `\\@cdots`;
  }),
  $(`\\dotsb`, `\\cdots`),
  $(`\\dotsm`, `\\cdots`),
  $(`\\dotsi`, `\\!\\cdots`),
...
($(
  `\\LaTeX`,
  `\\textrm{\\html@mathml{` +
    (`L\\kern-.36em\\raisebox{` + Wi + `}{\\scriptstyle A}`) +
    `\\kern-.15em\\TeX}{LaTeX}}`,
),
  $(
    `\\KaTeX`,
    `\\textrm{\\html@mathml{` +
      (`K\\kern-.17em\\raisebox{` + Wi + `}{\\scriptstyle A}`) +
      `\\kern-.15em\\TeX}{KaTeX}}`,
  ),
...
var Ki = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 },
  qi = class {
    constructor(e, t, n) {
      ((this.settings = t),
        (this.expansionCount = 0),
        this.feed(e),
        (this.macros = new Li(Ri, t.macros)),
        (this.mode = n),
        (this.stack = []));
    }
    feed(e) {
    ...
    scanArgument(e) {
      ...
      return (
        this.pushToken(new Rr(`EOF`, n.loc)),
        this.pushTokens(r),
        new Rr(``, Lr.range(t, n))
      );
    }
    ...
    consumeArgs(t, n) {
      if (n) {
        ...
        for (var r = n[0], i = 0; i < r.length; i++) {
          var a = this.popToken();
          if (r[i] !== a.text)
            throw new e(`Use of the macro doesn't match its definition`, a);
        }
      }
      for (var o = [], s = 0; s < t; s++)
        o.push(this.consumeArg(n && n[s + 1]).tokens);
      return o;
    }
    countExpansion(t) {
      if (
        ((this.expansionCount += t),
    ...
    expandOnce(t) {
      ...
      if (i == null || (t && i.unexpandable)) {
        if (t && i == null && r[0] === `\\` && !this.isDefined(r))
          throw new e(`Undefined control sequence: ` + r);
        return (this.pushToken(n), !1);
      }
      this.countExpansion(1);
      var a = i.tokens,
        o = this.consumeArgs(i.numArgs, i.delimiters);
      if (i.numArgs) {
        a = a.slice();
        for (var s = a.length - 1; s >= 0; --s) {
          ...
          if (c.text === `#`) {
            if (s === 0)
              throw new e(`Incomplete placeholder at end of macro body`, c);
    ...
    _getExpansion(e) {
      ...
      if (typeof r == `string`) {
        var i = 0;
        if (r.includes(`#`))
          for (var a = r.replace(/##/g, ``); a.includes(`#` + (i + 1)); ) ++i;
        for (
          var o = new Ii(r, this.settings), s = [], c = o.lex();
          c.text !== `EOF`;
    ...
    isDefined(e) {
      return (
        this.macros.has(e) ||
        Di.hasOwnProperty(e) ||
        k.math.hasOwnProperty(e) ||
        k.text.hasOwnProperty(e) ||
        Ki.hasOwnProperty(e)
      );
    }
    isExpandable(e) {
      var t = this.macros.get(e);
      return t == null
        ? Di.hasOwnProperty(e) && !Di[e].primitive
        : typeof t == `string` || typeof t == `function` || !t.unexpandable;
    }
  },
  Ji = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
  Yi = Object.freeze({
    "₊": `+`,
    "₋": `-`,
    "₌": `=`,
  ...
  Qi = class t {
    constructor(e, t) {
      ((this.mode = `math`),
        (this.gullet = new qi(e, t, this.mode)),
        (this.settings = t),
    ...
    parseExpression(e, n) {
      for (var r = []; ; ) {
        ...
        var i = this.fetch();
        if (
          t.endOfExpression.has(i.text) ||
          (n && i.text === n) ||
          (e && Di[i.text] && Di[i.text].infix)
        )
          break;
    ...
    handleInfixNodes(t) {
      for (var n = -1, r, i = 0; i < t.length; i++) {
        ...
        if (a.type === `infix`) {
          if (n !== -1)
            throw new e(`only one infix operator per group`, a.token);
          ((n = i), (r = a.replaceWith));
        }
      }
      if (n !== -1 && r) {
    ...
    parseAtom(t) {
      ...
      for (var r, i; ; ) {
        ...
        if (a.text === `\\limits` || a.text === `\\nolimits`) {
          if (n && n.type === `op`)
            ((n.limits = a.text === `\\limits`), (n.alwaysHandleSupSub = !0));
          ...
          (this.fetch().text === `^` &&
            ...
            (r = { type: `ordgroup`, mode: this.mode, body: s }));
        } else if (Yi[a.text]) {
          var c = Ji.test(a.text),
            l = [];
          for (l.push(new Rr(Yi[a.text])), this.consume(); ; ) {
            var u = this.fetch().text;
            if (!Yi[u] || Ji.test(u) !== c) break;
            (l.unshift(new Rr(Yi[u])), this.consume());
          }
          var d = this.subparse(l);
          c
            ? (i = { type: `ordgroup`, mode: `math`, body: d })
            : (r = { type: `ordgroup`, mode: `math`, body: d });
        } else break;
      }
      return r || i
    ...
    parseFunction(t, n) {
      ...
      if (this.mode === `text` && !a.allowedInText)
        throw new e(`Can't use function '` + i + `' in text mode`, r);
      if (this.mode === `math` && a.allowedInMath === !1)
        throw new e(`Can't use function '` + i + `' in math mode`, r);
      var { args: o, optArgs: s } = this.parseArguments(i, a);
      return this.callFunction(i, o, s, r, t);
    }
    callFunction(t, n, r, i, a) {
      var o = { funcName: t, parser: this, token: i, breakOnTokenText: a },
        s = Di[t];
    ...
    parseArguments(t, n) {
      ...
      for (var i = [], a = [], o = 0; o < r; o++) {
        var s = n.argTypes && n.argTypes[o],
          c = o < n.numOptionalArgs;
        ((`primitive` in n && n.primitive && s == null) ||
          (n.type === `sqrt` && o === 1 && a[0] == null)) &&
          (s = `primitive`);
    ...
    parseRegexGroup(t, n) {
      for (
        var r = this.fetch(), i = r, a = ``, o;
        (o = this.fetch()).text !== `EOF` && t.test(a + o.text);

      )
        ((i = o), (a += i.text), this.consume());
    ...
    parseSizeGroup(t) {
      ...
      if (!Ce(a)) throw new e(`Invalid unit: '` + a.unit + `'`, n);
    ...
    parseGroup(t, n) {
      ...
      if (i === `{` || i === `\\begingroup`) {
        ...
        ((a = this.parseFunction(n, t) || this.parseSymbol()),
        a == null && i[0] === `\\` && !Ki.hasOwnProperty(i))
      ) {
        if (this.settings.throwOnError)
          throw new e(`Undefined control sequence: ` + i, r);
    ...
    parseSymbol() {
      ...
      if (/^\\verb[^a-zA-Z]/.test(n)) {
        ...
        var r = n.slice(5),
          i = r.charAt(0) === `*`;
        if (
          (i && (r = r.slice(1)), r.length < 2 || r.charAt(0) !== r.slice(-1))
        )
      ...
      if (k[this.mode][n]) {
        ...
        var s = k[this.mode][n].group,
          c = Lr.range(t),
          l;
        if (qe.hasOwnProperty(s)) {
          var u = s;
          l = { type: `atom`, mode: this.mode, family: u, loc: c, text: n };
        } else l = { type: s, mode: this.mode, loc: c, text: n };
        o = l;
        ...
        (this.settings.strict &&
          ...
          (o = { type: `textord`, mode: `text`, loc: Lr.range(t), text: n }));
      else return null;
      if ((this.consume(), a))
        for (var d = 0; d < a[0].length; d++) {
          var f = a[0][d];
          if (!Xi[f]) throw new e(`Unknown accent ' ` + f + `'`, t);
          var p = Xi[f][this.mode] || Xi[f].text;
          if (!p)
            throw new e(
              `Accent ` + f + ` unsupported in ` + this.mode + ` mode`,
              t,
            );
          o = {
            type: `accent`,
...
Qi.endOfExpression = new Set([`}`, `\\endgroup`, `\\end`, `\\right`, `&`]);
var $i = function (t, n) {
...
//# sourceMappingURL=katex-CjHJ1D7d.js.map
