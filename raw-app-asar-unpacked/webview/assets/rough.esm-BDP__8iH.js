...
function n(n, r, i, a = 1) {
  let o = i,
    s = Math.max(r, 0.1),
    c = n[0] && n[0][0] && typeof n[0][0] == `number` ? [n] : n,
    l = [0, 0];
  if (o) for (let t of c) e(t, l, o);
  ...
  if (o) {
    for (let t of c) e(t, l, -o);
    (function (t, n, r) {
      let i = [];
      (t.forEach((e) => i.push(...e)), e(i, n, r));
    })(u, l, -o);
  }
  return u;
}
...
var o = class extends i {
    fillPolygons(e, t) {
      ...
      let i = r(e, Object.assign({}, t, { hachureGap: n })),
  ...
  c = class {
    ...
    fillPolygons(e, t) {
      let n = r(e, (t = Object.assign({}, t, { hachureAngle: 0 })));
  ...
  u = class {
    ...
    fillPolygons(e, t) {
      let n = t.hachureGap < 0 ? 4 * t.strokeWidth : t.hachureGap,
        i = t.zigzagOffset < 0 ? n : t.zigzagOffset,
        a = r(e, (t = Object.assign({}, t, { hachureGap: n + i })));
      return { type: `fillSketch`, ops: this.zigzagLines(a, i, t) };
    }
    zigzagLines(e, t, n) {
      let r = [];
      return (
...
function h(e) {
  ...
  for (; !m(a, 2); ) {
    let o = 0,
      s = [];
    if (r === `BOD`) {
      if (a.text !== `M` && a.text !== `m`) return h(`M0,0` + e);
      (i++, (o = p[a.text]), (r = a.text));
    } else m(a, 1) ? (o = p[r]) : (i++, (o = p[a.text]), (r = a.text));
    if (!(i + o < n.length)) throw Error(`Path data ended short`);
    for (let e = i; e < i + o; e++) {
      let t = n[e];
      if (!m(t, 1)) throw Error(`Param not a number: ` + r + `,` + t.text);
      s[s.length] = +t.text;
    }
    if (typeof p[r] != `number`) throw Error(`Bad segment: ` + r);
    {
      let e = { key: r, data: s };
      (t.push(e),
        (i += o),
    ...
    switch (l) {
      ...
      case `A`: {
        ...
        e === 0 || n === 0
          ...
          : (r !== c || i !== l) &&
            (y(r, i, c, l, e, n, a, o, s).forEach(function (e) {
              t.push({ key: `C`, data: e });
            }),
            (r = c),
            (i = l));
...
function y(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (((O[0] = 2 * D[0] - O[0]), (O[1] = 2 * D[1] - O[1]), l))
    return [O, k, A].concat(f);
  {
    f = [O, k, A].concat(f);
    let e = [];
    for (let t = 0; t < f.length; t += 3) {
      let n = v(f[t][0], f[t][1], u),
        r = v(f[t + 1][0], f[t + 1][1], u),
        i = v(f[t + 2][0], f[t + 2][1], u);
...
const b = {
  ...
  ellipse: function (e, t, n, r, i) {
    return E(e, t, i, T(n, r, i)).opset;
  },
  doubleLineOps: function (e, t, n, r, i) {
    return F(e, t, n, r, i, !0);
  },
};
function x(e, t, n, r, i) {
  return { type: `path`, ops: F(e, t, n, r, i) };
}
function S(e, t, n) {
  let r = (e || []).length;
  if (r > 2) {
    let i = [];
    for (let t = 0; t < r - 1; t++)
      i.push(...F(e[t][0], e[t][1], e[t + 1][0], e[t + 1][1], n));
    return (
      t && i.push(...F(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)),
      { type: `path`, ops: i }
    );
  }
  return r === 2
    ? x(e[0][0], e[0][1], e[1][0], e[1][1], n)
    : { type: `path`, ops: [] };
}
...
function w(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      r = L(n[0], 1 * (1 + 0.2 * t.roughness), t),
      i = t.disableMultiStroke
        ? []
        : L(n[0], 1.5 * (1 + 0.22 * t.roughness), j(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = L(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke
            ? []
            : L(a, 1.5 * (1 + 0.22 * t.roughness), j(t));
...
function E(e, t, n, r) {
  let [i, a] = z(
      ...
      r.ry,
      1,
      r.increment * N(0.1, N(0.4, 1, n), n),
      n,
    ),
    o = R(i, null, n);
  if (!n.disableMultiStroke && n.roughness !== 0) {
    let [i] = z(r.increment, e, t, r.rx, r.ry, 1.5, 0, n),
      a = R(i, null, n);
    o = o.concat(a);
  }
...
function D(e, t, n, r, i, a, o, s, c) {
  ...
  let h = (2 * Math.PI) / c.curveStepCount,
    ...
    _ = B(g, l, u, d, f, p, m, 1, c);
  if (!c.disableMultiStroke) {
    let e = B(g, l, u, d, f, p, m, 1.5, c);
    _.push(...e);
  }
  return (
    o &&
      (s
        ? _.push(
            ...F(l, u, l + d * Math.cos(p), u + f * Math.sin(p), c),
            ...F(l, u, l + d * Math.cos(m), u + f * Math.sin(m), c),
          )
        : _.push(
            { op: `lineTo`, data: [l, u] },
  ...
  for (let { key: e, data: o } of n)
    switch (e) {
      case `M`:
        ...
        break;
      case `L`:
        (r.push(...F(a[0], a[1], o[0], o[1], t)), (a = [o[0], o[1]]));
        break;
      case `C`: {
        let [e, n, i, s, c, l] = o;
        (r.push(...V(e, n, i, s, c, l, a, t)), (a = [c, l]));
        break;
      }
      case `Z`:
        (r.push(...F(a[0], a[1], i[0], i[1], t)), (a = [i[0], i[1]]));
    }
  ...
  for (let r of e)
    if (r.length) {
      let e = t.maxRandomnessOffset || 0,
        i = r.length;
      if (i > 2) {
        n.push({ op: `move`, data: [r[0][0] + P(e, t), r[0][1] + P(e, t)] });
        for (let a = 1; a < i; a++)
          n.push({
            op: `lineTo`,
            data: [r[a][0] + P(e, t), r[a][1] + P(e, t)],
          });
      }
    }
    ...
    if (!d[n])
      switch (n) {
        ...
        case `zigzag-line`:
          ...
          break;
        default:
          ((n = `hachure`), d[n] || (d[n] = new i(t)));
      }
    return d[n];
  })(t, b).fillPolygons(e, t);
}
function j(e) {
...
function M(e) {
  return ((e.randomizer ||= new f(e.seed || 0)), e.randomizer.next());
}
function N(e, t, n, r = 1) {
  return n.roughness * r * (M(n) * (t - e) + e);
}
function P(e, t, n = 1) {
  return N(-e, e, t, n);
}
function F(e, t, n, r, i, a = !1) {
  let o = a ? i.disableMultiStrokeFill : i.disableMultiStroke,
    s = I(e, t, n, r, i, !0, !1);
  if (o) return s;
  let c = I(e, t, n, r, i, !0, !0);
  return s.concat(c);
}
  ...
  return (
    a &&
      (o
        ...
        : h.push({
            op: `move`,
            data: [e + (v ? 0 : P(u, i, l)), t + (v ? 0 : P(u, i, l))],
          })),
    o
      ? h.push({
          op: `bcurveTo`,
...
function L(e, t, n) {
  if (!e.length) return [];
  let r = [];
  (r.push([e[0][0] + P(t, n), e[0][1] + P(t, n)]),
    r.push([e[0][0] + P(t, n), e[0][1] + P(t, n)]));
  for (let i = 1; i < e.length; i++)
    (r.push([e[i][0] + P(t, n), e[i][1] + P(t, n)]),
      i === e.length - 1 && r.push([e[i][0] + P(t, n), e[i][1] + P(t, n)]));
  return R(r, null, n);
}
function R(e, t, n) {
  let r = e.length,
  ...
  if (r > 3) {
    ...
    if (t && t.length === 2) {
      ...
      i.push({ op: `lineTo`, data: [t[0] + P(e, n), t[1] + P(e, n)] });
    }
  } else
    r === 3
      ? (i.push({ op: `move`, data: [e[1][0], e[1][1]] }),
      ...
      : r === 2 && i.push(...I(e[0][0], e[0][1], e[1][0], e[1][1], n, !0, !0));
  return i;
}
function z(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    let u = P(0.5, s) - Math.PI / 2;
    l.push([
      P(a, s) + t + 0.9 * r * Math.cos(u - e),
      P(a, s) + n + 0.9 * i * Math.sin(u - e),
    ]);
    let d = 2 * Math.PI + u - 0.01;
    for (let o = u; o < d; o += e) {
      let e = [P(a, s) + t + r * Math.cos(o), P(a, s) + n + i * Math.sin(o)];
      (c.push(e), l.push(e));
    }
    (l.push([
      P(a, s) + t + r * Math.cos(u + 2 * Math.PI + 0.5 * o),
      P(a, s) + n + i * Math.sin(u + 2 * Math.PI + 0.5 * o),
    ]),
      l.push([
        P(a, s) + t + 0.98 * r * Math.cos(u + o),
        P(a, s) + n + 0.98 * i * Math.sin(u + o),
      ]),
      l.push([
        P(a, s) + t + 0.9 * r * Math.cos(u + 0.5 * o),
        P(a, s) + n + 0.9 * i * Math.sin(u + 0.5 * o),
      ]));
  }
  return [l, c];
}
function B(e, t, n, r, i, a, o, s, c) {
  let l = a + P(0.1, c),
    u = [];
  u.push([
    P(s, c) + t + 0.9 * r * Math.cos(l - e),
    P(s, c) + n + 0.9 * i * Math.sin(l - e),
  ]);
  for (let a = l; a <= o; a += e)
    u.push([P(s, c) + t + r * Math.cos(a), P(s, c) + n + i * Math.sin(a)]);
  return (
...
function V(e, t, n, r, i, a, o, s) {
  ...
  for (let p = 0; p < d; p++)
    (p === 0
      ...
      : c.push({
          op: `move`,
          data: [o[0] + (f ? 0 : P(l[0], s)), o[1] + (f ? 0 : P(l[0], s))],
        }),
      (u = f ? [i, a] : [i + P(l[p], s), a + P(l[p], s)]),
      c.push({
        op: `bcurveTo`,
        data: [
          e + P(l[p], s),
...
function U(e, t = 0) {
  ...
  let r = [];
  if (n === 3) r.push(H(e[0]), H(e[1]), H(e[2]), H(e[2]));
  else {
    let n = [];
    n.push(e[0], e[0]);
...
function G(e, t, n) {
  ...
  return ((i = Math.max(0, Math.min(1, i))), W(e, K(t, n, i)));
}
function K(e, t, n) {
...
function q(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length
      ? ((a = i[i.length - 1]), (o = n), Math.sqrt(W(a, o))) > 1 && i.push(n)
      : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      ...
      p = K(u, d, r),
      m = K(f, p, r);
    (q([a, l, f, m], 0, n, i), q([m, p, d, c], 0, n, i));
  }
  var a, o;
  return i;
}
function J(e, t) {
  return Y(e, 0, e.length, t);
}
function Y(e, t, n, r, i) {
  ...
  return (
    Math.sqrt(c) > r
      ? (Y(e, t, l + 1, r, a), Y(e, l, n, r, a))
      : (a.length || a.push(o), a.push(s)),
    a
  );
}
function X(e, t = 0.15, n) {
  let r = [],
    i = (e.length - 1) / 3;
  for (let n = 0; n < i; n++) q(e, 3 * n, t, r);
  return n && n > 0 ? Y(r, 0, r.length, n) : r;
}
const Z = `none`;
var Q = class {
    constructor(e) {
    ...
    line(e, t, n, r, i) {
      let a = this._o(i);
      return this._d(`line`, [x(e, t, n, r, a)], a);
    }
    rectangle(e, t, n, r, i) {
      let a = this._o(i),
        o = [],
      ...
      if (a.fill) {
        ...
        a.fillStyle === `solid` ? o.push(k([i], a)) : o.push(A([i], a));
      }
    ...
    ellipse(e, t, n, r, i) {
      ...
      if (a.fill)
        if (a.fillStyle === `solid`) {
          let n = E(e, t, a, s).opset;
          ((n.type = `fillPath`), o.push(n));
        } else o.push(A([c.estimatedPoints], a));
            ...
            for (let r of e)
              r.length < 3
                ...
                : r.length === 3
                  ...
                  : t.push(...X(U(r), 10, (1 + n.roughness) / 2));
          }
          t.length && r.push(A([t], n));
        }
    ...
    polygon(e, t) {
      ...
      return (
        n.fill &&
          (n.fillStyle === `solid` ? r.push(k([e], n)) : r.push(A([e], n))),
        n.stroke !== Z && r.push(i),
        this._d(`polygon`, r, n)
      );
    }
    ...
    fillSketch(e, t) {
      ...
      return (
        ...
        { d: this.opsToPath(e), stroke: t.fill || Z, strokeWidth: n, fill: Z }
      );
    }
    _mergedShape(e) {
...
var te = class {
  ...
  ne = {
    canvas: (e, t) => new ee(e, t),
    svg: (e, t) => new te(e, t),
    generator: (e) => new Q(e),
    newSeed: () => Q.newSeed(),
  };
export { ne as t };
//# sourceMappingURL=rough.esm-BDP__8iH.js.map
