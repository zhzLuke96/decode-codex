...
function f(t, n, r, i) {
  ...
  function o(t, i, a, o, s, c) {
    if (t !== a || i !== o) {
      var l = s.push(`translate(`, null, n, null, r);
      c.push({ i: l - 4, x: e(t, a) }, { i: l - 2, x: e(i, o) });
  ...
  function s(t, n, r, o) {
    t === n
      ...
      : (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
        o.push({ i: r.push(a(r) + `rotate(`, null, i) - 2, x: e(t, n) }));
  }
  function c(t, n, r, o) {
    t === n
      ? n && r.push(a(r) + `skewX(` + n + i)
      : o.push({ i: r.push(a(r) + `skewX(`, null, i) - 2, x: e(t, n) });
  }
  function l(t, n, r, i, o, s) {
    if (t !== r || n !== i) {
      var c = o.push(a(o) + `scale(`, null, `,`, null, `)`);
      s.push({ i: c - 4, x: e(t, r) }, { i: c - 2, x: e(n, i) });
...
//# sourceMappingURL=src-C5z3DuP3.js.map
